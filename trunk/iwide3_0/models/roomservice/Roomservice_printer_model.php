<?php
class Roomservice_Printer_Model extends MY_Model{
	function __construct() {
		parent::__construct ();
	}

	const TAB_PRINTER = 'roomservice_printer_info';

	public function get_resource_name()
	{
		return 'Roomservice_Printer_Model';
	}
    ...
    public function get_count($filter = NULL, $where = NULL) {
        ...
        //查询
        $sql = 'select count(*) as c from ' . $this->_db('iwide_r1')->dbprefix ( self::TAB_PRINTER ) . $where;
    ...
    public function get_list(array $filter = NULL, $page = 0, $page_size = 0, array $order_by = NULL,$where = NULL){//var_dump($filter);die;
        ...
        //查询
        $sql  = 'select * from ' . $this->_db('iwide_r1')->dbprefix ( self::TAB_PRINTER ) . $where . $order_by . $limit;

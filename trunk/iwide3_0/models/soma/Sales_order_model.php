...
class Sales_order_model extends MY_Model_Soma {
    ...
    private function _order_save($business, $inter_id, $master_oid = null)
    {
        ...
        if (isset($extra['mail']) && !empty($extra['mail'])) {
            ...
            $note = (isset($extra['mail']['note'])) ? $extra['mail']['note'] : '';
	    ...
	    switch($settlement){
	        case 'groupon':
	            ...
	            if($grouponStatus == $activityGrouponModel::GROUP_STATUS_FINISHED){  //拼团订单成团
	                ...
	                $messageWxtempTemplateModel->send_template_by_groupon_success( $activityGrouponModel, $groupon['inter_id'], $business, !empty($childs));
...
//            SETTLE_HOTEL_GIFT
            ...
            if($send_flag && $settlement != $giftType) { //注:礼包派送不发送模板消息
                 ...
                 */
                $messageWxtempTemplateModel = $this->MessageWxtempTemplateModel;
                $messageWxtempTemplateModel->send_template_by_buy_success( $this, $openid, $inter_id, $business, !empty($childs));
            }

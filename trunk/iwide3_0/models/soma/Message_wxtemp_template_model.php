...
// var_dump( $message );exit;
    ...
    */
    public function send_template_by_groupon_success( $activityGrouponModel, $inter_id, $business, $composeOrder = false)
    {
        try {
     ...
     * Usage $model->groupon_success(模版类型, 活动对象, 公众号, 业务类型)
    */
    public function send_template_by_buy_success( $salesOrderModel, $openid, $inter_id, $business, $composeOrder = false)
    {
        try {

...
$db[$active_group]['hostname'] = '30.iwide.cn';
$db[$active_group]['database'] = 'iwide30dev_2016011813';

/** ************ 多数据库连接配置 ************* **/
$db['iwide_r1'] = $db[$active_group];
$db['iwide_r1']['hostname'] = '30.iwide.cn'; //兼容性问题，请勿用 localhost

$db['member_write'] = $db[$active_group];
$db['member_read'] = $db[$active_group];

$db['iwide_vip'] = $db[$active_group];
$db[$member_group]['hostname'] = 'iwidevip.mysql.rds.aliyuncs.com';    //兼容性问题，请勿用 localhost
$db[$member_group]['database'] = 'iwide30vip';
$db[$member_group]['username'] = 'iwide30vip';
$db[$member_group]['password'] = 'A4FStQJRdTCtVUnG';

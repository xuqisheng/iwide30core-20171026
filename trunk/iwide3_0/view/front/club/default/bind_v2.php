...
<div class="detail_list bg_fff bdradius martop overflow">
    <div class="pad3"><em class="iconfont icon">&#xE60f;</em>亲，激活你的社群帮信息</div>
    <ul class="pad10" style="padding-left:32px; padding-top:0">
    	<li>帮派名：<?php echo $club_name;?></li>
    	<li>价　格：<?php echo $price_name;?></li>
...
<form id="pinfo" class="list_style_2 add_new_list martop bdradius overflow" method="post">
    ...
    <!--input type="hidden" id="club_name" readonly value="<?php echo $club_name;?>"/>
    <input type="hidden" id="price_code" readonly value="<?php echo $price_name;?>"/>
    <input type='hidden' name='<?php echo $csrf_token; ?>' value='<?php echo $csrf_value; ?>' /-->
</form>
<div class="whiteblock bdradius overflow color_main" style="padding-left:32px">温馨提示:<br>加入前请确认你要加入的社群帮的信息</div>

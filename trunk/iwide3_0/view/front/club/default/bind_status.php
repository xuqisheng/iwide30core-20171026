...
<div class="foot_btn martop">
	<a href="<?php if($is_multy==2){echo site_url('hotel/hotel/search');}else{echo site_url("hotel/hotel/index?id={$inter_id}");}?>" class="btn_main h28 submitbtn">马上订房</a>
</div>

<?php if(isset($club_info['soma_code']) && !empty($club_info['soma_code'])){ ?>
    <div class="foot_btn martop">
        <a href="<?php echo site_url("soma/package/index?id={$inter_id}");?>" class="btn_main h28 submitbtn">马上购买</a>
    </div>
<?php }?>

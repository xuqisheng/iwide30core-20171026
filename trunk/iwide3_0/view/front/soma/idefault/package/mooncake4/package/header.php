...
<head>
    ...
    <link href="<?php echo get_cdn_url('public/soma/styles/theme.css');?>" rel="stylesheet">
     <link href="<?php echo base_url('public/soma/mooncake4/css/swiper.css');?>" rel="stylesheet">
	  <link href="<?php echo base_url('public/soma/mooncake4/css/style.css');?>" rel="stylesheet">

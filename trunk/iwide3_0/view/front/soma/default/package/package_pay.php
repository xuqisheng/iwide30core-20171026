...
<style>
    ...
    .jfk-input__radio input[type="radio"] ~ .uncheck {display:inline-block;border: solid 1px #888888; border-radius: 50%; width: 16px; height: 16px;margin-right: 2px;vertical-align: middle;}
    ...
    .jfk-cup-line:after {
        ...
        width: 100%;
        height: 3px;
        background-image: url(http:///7n.cdn.iwide.cn/public/soma/images/cup_line.png);
        background-position: center center;
        background-size: cover;
    }
    .product_since, .gift_process {
        display: none;
        line-height: 1.5;
        color: #888888;
        font-size: 14px;
    ...
    @media only screen and (max-width: 320px) {
        .mail_list .mail_tip{width: 65px; font-size: 13px;}
        ...
        .jfk-input__radio span{font-size: 13px;}
        .product_since, .gift_process {
            font-size: 12px;
        }
    }
...
<?php
	$showChoose = false;
	$mailShowFlag = $package['can_mail'] == $packageModel::CAN_T ? true : false;
	$giftShowFlag = $package['can_gift'] == $packageModel::CAN_T ? true : false;
	$pickShowFlag = $package['can_pickup'] == $packageModel::CAN_T ? true : false;
    if( ($mailShowFlag && $giftShowFlag) || ($giftShowFlag && $pickShowFlag)  || ($mailShowFlag && $pickShowFlag) )
		$showChoose = true;
?>
...
<div class="mail_list">
    <div class="justify webkitbox bd_bottom mail_type" <?php if(!$showChoose) echo 'style="display:none;"';?> >
		...
		<?php if($package['can_gift'] == $packageModel::CAN_T){ ?>
			<label class="jfk-input__radio">
                ...
                <em class="uncheck"></em><em class="checked iconfont color_main">&#xe61e;</em><span>赠送他人</span></label>
                <!-- <span class="mail_gift_tip"><em>!</em>如何赠送</span> -->
        <?php } ?>

        <?php if($package['can_pickup'] == $packageModel::CAN_T){ ?>
            <label class="jfk-input__radio"><input type="radio" class="jfk-input__radio-mail" name="mail" <?php if($package['can_mail'] != $packageModel::CAN_T && ($package['can_gift'] != $packageModel::CAN_T)) echo ' checked ';?> value="3"><em class="uncheck"></em><em class="checked iconfont color_main">&#xe61e;</em><span>到店自提</span></label>
        <?php } ?>

		</div>
    </div>

    <div class="product_since">
        自提地址：<?php echo $package['hotel_address'];?>
    </div>
...
<div class="whiteblock bd_bottom support_list" style="margin-top:0">
    ...
    <?php if($refund && $package['can_refund'] != $packageModel::CAN_REFUND_STATUS_FAIL && $package['type'] != $packageModel::PRODUCT_TYPE_BALANCE && $package['type'] != $packageModel::PRODUCT_TYPE_POINT): ?>
...
<div class="order_list bd_bottom martop jfk-cup-line">
...
<ul class="list_style_1 bd  martop">
    ...
    <?php if($package['can_mail'] == $packageModel::CAN_T){?>
    <li class="justify webkitbox" id="remark" <?php if($gift) echo 'style="display:none;"';?>>
        <span>邮寄备注</span>
        <input type="text" name="remark" placeholder="请输入邮寄备注" id="mailRemark">
    </li>
    <?php } ?>
</ul>
...
var _submit = function(){
        ...
        if (userAddressArr !== null && $('[name="mail"]').filter(':checked').val() === '1') {
			...
			ajaxData.remark = $('[name="remark"]').val();
        }
        $.ajax({
			async: true,
            type: 'POST',
...
var $productSince = $('.product_since')
var $remark = $('#remark')
        ...
        if (result.status === 1){
            ...
            saveUserAddr($.param(result.service), function (res){
                ...
                if (res.status === 1) {
                    ...
                    result.source.address_id = addressId

...
<div class="list_style_1 bd martop">
    ...
    <div class="input_item">
        <span>纳税人识别号</span>
        <span><input type="text" id="taxpayer" maxlength="17" placeholder="请输入您司纳税人识别号" name="taxId" value="<?php echo $invoice->m_get('tax_id'); ?>" /></span>
    </div>
</div>
<div class="list_style_1 martop bd">
    <div class="input_item">
        <span><?php echo $lang->line('recipient');?></span>
        <span><input type="text" placeholder="<?php echo $lang->line('fill_recipient_name_tip');?>"  name="name" value="<?php if( $address->m_get('address_id') ) : echo $address->m_get('contact'); endif;?>" /></span>
    </div>
    <div class="input_item">
        <span><?php echo $lang->line('recipient_phone_number');?></span>
        <span><input type="tel" placeholder="<?php echo $lang->line('fill_recipient_call_tip');?>"  name="mobile" value="<?php if( $address->m_get('address_id') ) : echo $address->m_get('phone'); endif;?>" /></span>
    </div>
</div>
<div class="list_style_1 martop bd">
...
<script>
    var billTitle,name,mobile,area,province,city,region,address;
    function getval(){

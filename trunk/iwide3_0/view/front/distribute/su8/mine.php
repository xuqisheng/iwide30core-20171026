<link href="<?php echo base_url('public/distribute/su8/styles/ui.css')?>" rel="stylesheet">
<link href="<?php echo base_url('public/distribute/su8/styles/my_css.css')?>" rel="stylesheet">
...
<div class="head">
    <div class="padding">
        ...
        <div class="user_name"><?php echo $saler_details['name']?><span class="viplv_black">分销号:  <?php echo $saler_details['id']?></span></div>
        <div class="viplv_black"><?php echo $saler_details['hotel_name']?>  <?php //echo $saler_details['master_dept'];?></div>
    </div>
    <div class="mask">
        <div class="lis">
...
<div class="ui_btn_list ui_border" style="display: none">
    <a class="item _haibao">
        <em class="ui_ico ui_ico3"></em>
        <tt>生成二维码海报 </tt>
    </a>
</div>
<?php if($this->input->get('id') == 'a452223043' || $this->input->get('id') == 'a450939254' ||$this->input->get('id') == 'a445223616' ||$this->input->get('id') == 'a449675133' ):?>
<?php endif;?>

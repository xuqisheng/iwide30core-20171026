...
<div class="box">
	...
	<div class="selsct">
    	<span class="front"><?php if($inter_id == 'a467353624'):?>车队<?php elseif($inter_id == 'a488251814'):?>渠道<?php else: ?>部门<?php endif;?></span>
        <span>
        <?php if(is_null($depts)):?><input type="text" placeholder="<?php if($inter_id == 'a467353624'):?>车队<?php elseif($inter_id == 'a488251814'):?>渠道<?php else: ?>部门<?php endif;?>" name="department" id="department" value="<?php if (isset($saler['master_dept'])):echo $saler['master_dept'];endif;?>" />
	...
	<div class="selsct s_h">
    	<span class="front"><?php if($inter_id == 'a467353624'):?>分公司<?php elseif($inter_id == 'a488251814'):?>所属公司<?php else: ?>所属酒店<?php endif;?></span>
        <span class="s"><em style="color:#999;"><?php if($inter_id == 'a467353624'):?>请选择分公司<?php elseif($inter_id == 'a488251814'):?>请选择【藏地香格里拉驿站】<?php else: ?>请选择酒店<?php endif;?></em></span>
    </div>
    <div class="pull">
    ...
    <input type="hidden" name="dis_sess_code" id="dis_sess_code" value='<?php echo $dis_sess_code?>' />
	<!-- <div class="selsct">

...
<div class="gradient_bg">
    <div class="relative big_banner">
        ...
        <a class="bg_alpha block wrapper" href="<?php echo Hotel_base::inst()->get_url("HOTEL_DETAIL",array('h'=>$hotel['hotel_id']));?>">
            ...
            <!--
                    <div class="sepc_tag color8 h20 iconfont">
                        <span>商务精选</span>
                        <span>预约发票</span>
                    </div> -->
            </div>
    ...
    <div class="wrapper" style="padding-top:0">
        <div class="bd_bottom webkitbox room_information" style="width:100%;">
            ...
            <span class="main_line room_list_line"></span>
            <div class="color3 h24 pad_r20" id="checkdate">
                <div>入住 <span class="color2 checkin h28"></span></div>
                <div>离店 <span class="color2 checkout h28"></span></div>
            </div>
            <div class="iconfont color2">&#xE014;</div>
        </div>
        <div class="main_tab webkitbox color2 center <?php if(empty($packages))echo 'hide_pack';?>"><!-- hide_pack -->
            ...
            <span class="main_tab_line"></span>
            <p class="main_tab_choose flexgrow h24 color3" id="business_portal" style="width:2rem;">商务入口<em class="iconfont">&#xE015;</em></p>
        </div>
                        ...
                        <div class="color3 pad_tb30 pad_lr30 h24 clearfix">
                            <?php if(!empty($r['state_info'])){?>
                                ...
                                <div class="discount_price">
                                  <span class="main_color1 iconfont mar_r5 h32">&#xFFE5;<tt class="h48"><?php echo $r['lowest']; ?></tt></span>
                                   <span class="color3 h24">起</span>  
                                </div> 
                                <?php }?>
                            <?php }?>
                            <span class="floatr pad_t10 room_collect"><em class="iconfont color1 room_triangle">&#xE013;</em> </span>
                        </div>
                ...
                <?php if(!empty($packages)){ foreach($packages as $pkeys=>$package_info){ ?>
                    <div class="item mar_b40 <?php if($package_info['package_info']['sale_way']!=1){ echo 'room_free_choice'; }?>" >
                        ...
                        <div class="color3 pad20 h24">
                            <span class="main_color1 iconfont h32">&#xFFE5<tt class="h48"><?php echo $package_info['package_info']['total_show_price'];?></tt></span>
        ...
        <div class="center pad_lr20 mar_t20 bd_top" style="padding-top:22px;">
...
//        r_temp+='<div class="room_list" id="reserve_room_list">';
       $.each(data.rooms,function(rk,rs){
            ...
            if(rs.state_info !=undefined){
                ...
                if(rs.lowest >=0){
                    r_temp+='<div class="discount_price"><span class="main_color1 iconfont mar_r5 h32">&#xFFE5;<tt class="h48">'+ rs.lowest+'</tt></span><span class="color3 h24">起</span></div>';
                }
            }

            r_temp+='<span class="floatr pad_t10 room_collect"><em class="iconfont color1 room_triangle">&#xE013;</em> </span> </div>';
        ...
        if(data.packages !=undefined && data.packages !=''){
            ...
            $.each(data.packages,function(pk,pi){
                ...
                p_temp +='<div class="color3 pad20 h24"><span class="main_color1 iconfont h32">&#xFFE5<tt class="h48">'+pi.package_info.total_show_price+'</tt></span>';
...
//        console.log(packages_array);
        ...
        p_temp+='<div class="shadow_r package_select_shadow"></div><p class="color1 h34">请勾选您需要的商品</p><p class="h28 mar_tb20"><span class="mar_r10 color3">组合已选房型</span>';
        ...
        $.each(choose_packages,function(k,g){
            ...
            p_temp+='<div class="commodity_img_content"><p class="color1 h34 pad_t40 pad_r20 txtclip goods_info" goods_id='+ g.goods_id+'>'+ g.goods_name + '</p>';
            p_temp+='<div class="mar_t20 mar_b20" style="margin-left:-18px;"><span class="main_color1 iconfont mar_r10"><tt class="iconfont h30">&#xFFE5;</tt><span class="h36 room_price">'+ g.price + '</span></span></div>';

            // p_temp+='<span class="color2 h24">'+ g.nums + g.unit + '</span></div></div>';

            p_temp+='<span class="color3 commodity_details_ico h26">详情  <i class="iconfont package_detail_ico">&#Xe013;</i></span><div class="inblock number_control h30 floatr">';
        ...
        p_temp+='<div class="fixed_btn main_bg1 pad_l80 flexjustify"><div class="color_fff pad_tb20"><span><tt class="h28">￥</tt><em class="h60 room_total">'+ room_price+'</em></span><span class="pad_l30 h30">选好了</span></div>';
...
//        var packages_detail = JSON.parse($(this).attr('packages'));
        ...
        pageloading();
        var show_pd = '';
        show_pd +='<div class="h20 layer_bg whole_eject_content pad_t40 scroll"><em class="close iconfont color1">&#xE000;</em><div class="main_tab center color2"><p class="main_tab_choose h32 color1" id="room_details">房型详情 <span class="shadow_b"></span></p>';
        ...
        $.post("<?php echo site_url('hotel/hotel/return_room_detail').'?id='.$inter_id; ?>",{
            ...
            show_pd +='<div id="room_details_contents" class="wrapper" style="padding-top:0px;"><div class="h20 pad_t20"><div class="squareimg room_description mar_b60" style="border-radius:0px;"><img src="'+data.room_img+'" alt=""></div>';
            ...
            if(sale_way==1){
                show_pd +='<div class="main_bg1 h34 pad_tb30 center w100" onclick="pay(this,event)" price_code='+ package_price_code + ' price_type='+ package_price_code +' room_id='+rmid+' packages_key='+packages_id+'>立即预定</div>';
            }
            ...
            if(packages_detail.items!=null){
                $.each(packages_detail.items,function(pk,p){
                    show_pd += '<p>'+p.goods_name+'</p>';
                    show_pd += '<p>'+p.details+'</p>';
                })
            }

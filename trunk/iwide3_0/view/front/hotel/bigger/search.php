       ...
       <div class="swiper-wrapper">
            <?php $i = 0; foreach ($pubimgs as $pi){?>
              <div class="swiper-slide search_top_img">
                  ...
                  <p class="search_top_word color1"><span class="h32"><?php  $i++; echo $i; ?></span><span class="h22">/<?php echo sizeof($pubimgs); ?></span></p>
              </div>
            <?php }?>
       </div>
    </div>
    <form action="<?php echo Hotel_base::inst()->get_url("SRESULT")?>" method="post" id="index_search">
      ...
      <div class="searchLayer mar_b80">
          ...
          <div class="flex center checkdate h22 mar_t40 mar_b60" id="checkdate">
              ...
              <div class="checkin">
                  <div class="color3 date-title h26">入&nbsp;&nbsp;住</div>
                  <div class="iconfont main_color1 day"></div>
                  <div class="date h26"></div>
              </div>
              <span class="main_line mar_t20"></span>
              <div class="checkout">
                  <div class="color3 date-title h26">离&nbsp;&nbsp;店</div>
                  <div class="iconfont main_color1 day"></div>
                  <div class="date h26"></div>
              </div>
              <span class="mar_l10 iconfont main_color1 h36">&#xe014;</span>
          </div>

...
<!--                        <div class="martop">新用户专享优惠券</div>-->
        ...
        <!--            <div class="webkitbox input_item">
            ...
            <?php }else{ ?>
                <div>
                    ...
                    <div class="webkitbox others center h28 pad_b60 submit_type">
    ...
    <section class="whole_all_eject gradient_bg" style="display:none;" id="serach_whole">
        <div class="mar_t20">
        ...
        <div class="coupon_wrap" id='votelist' style="margin-top: 40px">
        </div>

			...
			if(data.cards!=''){
				...
				$.each(data.cards,function(i,n){
					...
					if(n.coupon_type==undefined||n.coupon_type==''||n.coupon_type=='voucher'){
						temp+=' coupon_type="voucher" code='+n.code+' amount="'+n.reduce_cost+'" max_use_num="'+n.hotel_max_use_num+'" card_type="'+n.ci_id+'" use_num_type="'+n.hotel_use_num_type+'"><div class="checkbox"><em></em></div><div class="ui_vote"><p class="bordertop_img"></p><div class="vote_con">';
						temp+='<p class="ui_price ui_color">'+n.reduce_cost+'元</p>';
					}else if(n.coupon_type=='discount'){
						temp+=' coupon_type="discount" code='+n.code+' amount="'+n.reduce_cost+'" max_use_num="1" card_type="'+n.ci_id+'" use_num_type="order"><div class="checkbox"><em></em></div><div class="ui_vote"><p class="bordertop_img"></p><div class="vote_con">';

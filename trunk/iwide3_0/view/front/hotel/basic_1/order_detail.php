...
<!--     	<li><a href="#" class="normal ui_color">打车前往</a></li> -->
        ...
        <li><a 
        href="<?php if (!empty($hotel['arounds'])){?><?php echo site_url('hotel/hotel/arounds').'?id='.$inter_id.'&h='.$order['hotel_id']; }else{?>http://cps.dianping.com/mm/weixin/home?showwxpaytitle=1&utm_source=card<?php }?>"
         class="normal ui_color">酒店周边</a></li>

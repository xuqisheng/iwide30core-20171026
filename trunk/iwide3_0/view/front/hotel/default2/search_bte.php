...
<form action="sresult?id=<?php echo $inter_id?>" onsubmit="to_search($(this))" method="post" id="index_search">
    ...
    <div class="list_style index_list ">
        <div class="webkitbox">
            ...
            <a class="near color_main center" href='<?php echo site_url('hotel/check/nearby').'?id='.$inter_id;?>'>
        ...
        <div class="webkitbox searchbox arrow" style="padding:10px 0">
            <input name="keyword" placeholder="关键字/位置/名称" readonly class="keyword" url="<?php echo site_url('hotel/check/ajax_city_filter').'?id='.$inter_id;?>">
        </div>
    </div>
...
<div class="pad3 center martop" style="margin-top:0px; margin-bottom:5%; padding-top:0">
	<a href="http://hotels.liyewl.com/index.php/hotel/hotel/index?id=a451037398&h=1031" class="isable submitbtn bg_main" style="display:inline-block">白天鹅宾馆 快速预订通道</a>
</div>
<div class="pad3">

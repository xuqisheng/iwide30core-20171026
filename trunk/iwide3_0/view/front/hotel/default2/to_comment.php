    ...
    $.ajaxFileUpload({
        ...
        success:function (data) {
            ...
            if($('.addimg div').length<3){
                $('.addimg').append('<div class="j-add"></div>');
            }
        },
        error:function(err){
            $.MsgBox.Alert("上传失败");
            ...
            function showimg(){
                wx.getLocalImgData({
                    ...
                    success: function (res) {
                        ...
                        var _html = _html + '<div><img style="width:100%;"  value="'+localData+'" src="'+localData+'"/><input name="img_url[]" type="hidden"  value="'+localData+'"></div>';
                        $(".addimg").append(_html);
                    }

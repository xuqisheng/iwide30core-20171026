...
<header class="headers"> 
    <div class="headerslide">
    	...
    	<a class="slideson ui_img_auto_cut" href="hotel_photo?id=<?php echo $inter_id;?>&h=<?php echo $hotel['hotel_id']?>">
...
<div class="inrto_list">
	<a href='javascript:void(0)' onclick="tonavigate(<?php echo $hotel['longitude'];?>,<?php echo $hotel['latitude'];?>,'<?php echo $hotel['name'];?>','<?php echo $hotel['address'];?>')" class="ui_btn_block"><span class="txtclip"><?php echo $hotel['address'];?></span><span class="ui_color">地图</span></a>
...
<?php if(!empty($rooms)) foreach($rooms as $r){?>
	<div class="item" onClick="silde_down(this)">
        <div class="item_left" rid="<?php echo $r['room_info']['room_id']; ?>">
            ...
            <div class="sever" onclick="show_room_detail(this,event)"><?php if(!empty($r['room_info']['imgs']['hotel_room_service'])){foreach($r['room_info']['imgs']['hotel_room_service'] as $rs){echo $rs['info'].' '; }}?>&nbsp;</div>
...
<?php if(!empty($foot_ads)){ ?>
 <div class="vote_spread">
	...
	<?php foreach($foot_ads['ads'] as $fa){?>
	<a href="<?php $fa['ad_link'];?>" class="item" style="height:16em;margin-bottom: 3%;">
...
<div class="ui_pull detail_pull" style=" display:none;">
	<div class="pull_box">
        ...
        <div class="room_img"><img src=""/></div>
        <div class="scroll_content">
            <div class="sever" id="detail_service">
<!--                 <div><em class="iconfont">&#xeb;</em><span>24小时热水</span></div> -->
<!--                 <div><em class="iconfont">&#xe8;</em><span>无线上网</span></div> -->
<!--                 <div><em class="iconfont">&#xea;</em><span>餐厅</span></div> -->
<!--                 <div><em class="iconfont">&#xe4;</em><span>吹风机</span></div> -->
<!--                 <div><em class="iconfont">&#xe9;</em><span>行李寄存</span></div> -->
<!--                 <div><em class="iconfont">&#xe5;</em><span>叫醒服务</span></div> -->
<!--                 <div><em class="iconfont">&#xed;</em><span>接机服务</span></div> -->
<!--                 <div><em class="iconfont">&#xe7;</em><span>免费停车</span></div> -->
<!--                 <div><em class="iconfont">&#xe3;</em><span>有线上网</span></div> -->
            </div>
            <div class="content">
...
// 重新设置图片轮播的宽高比;
imgrate=640/290; 
var pullimgrate=imgrate;//500/260;
	...
	$.post("<?php echo site_url('hotel/hotel/return_room_detail').'?id='.$inter_id; ?>",{
		...
		if(data.imgs!=null&&data.imgs.hotel_room_lightbox!=null){
			$.each(data.imgs.hotel_room_lightbox,function(i,n){
				$('.detail_pull .room_img img').attr('src',n.image_url);
				return;
			});
		}
		else{
			$('.detail_pull .room_img img').attr('src',data.room_img);
		}
		...
		if(data.book_policy!=''){
			...
			$('.detail_pull .content').html('<p><?php echo nl2br(htmlspecialchars($hotel['book_policy']));?></p>');
		}
		$('.detail_pull .room_img').height($('.detail_pull .room_img').width()/pullimgrate);
	},'json');
	...
	$.post('/index.php/hotel/hotel/return_more_room?id=<?php echo $inter_id;?>',{
		...
		protrol_code:$('#protrol_code').val()
			...
			$.each(data.rooms,function(i,n){
				...
				temp+='&nbsp;</div><div class="backvote">入住返券</div></div>';
				if(n.state_info!=''){
					temp+='<div class="item_right">';
					temp+='<div class="ui_price"><b>'+n.lowest+'</b><tt class="ui_color_gray">起</tt></div><em class="ui_ico ui_ico12"></em></div>';
				}
				else{

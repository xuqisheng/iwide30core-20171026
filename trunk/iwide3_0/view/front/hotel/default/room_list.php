...
<div class="inrto_list">
	...
	<?php if(isset($middle_ads['ads']) && !empty($middle_ads['ads'])){?> 
<div class="inrto_list" style="border-width:1px 0; margin-top:3%">
	<?php foreach($middle_ads['ads'] as $fad){ foreach($fad as $fa){?>
	<a href="<?php echo $fa['ad_link'];?>" class=" color_link" style="padding:3% 0; display:block">
	    <span style="vertical-align:baseline" class="iconfont h32"><?php if(!strstr($fa['ad_img'],"http")) echo $fa['ad_img'];?></span>
	    <span><?php echo $fa['ad_title'];?></span>
	    <span class="ui_color"></span>
	</a>
	<?php }}?>
</div>
	<?php }?>

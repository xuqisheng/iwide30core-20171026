...
<header class="headers"> 
  ...
  <?php foreach ($pubimgs as $pi){?>
  	  <a class="slideson ui_img_auto_cut" href="<?php echo Hotel_base::inst()->get_url($pi['link'],array(),TRUE)?>">
...
<?php if(isset($foot_ads['ads']) && !empty($foot_ads['ads'])){ ?>
 <div class="bg_fff" style="padding:3%;">
	...
	<a href="<?php echo Hotel_base::inst()->get_url($fa['ad_link'],array(),TRUE);?>" style="margin-bottom: 3%; display:block">

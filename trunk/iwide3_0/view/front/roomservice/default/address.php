...
<page class="page">
    ...
    <section class="scroll flexgrow h26">
    	<div class="list_style_1">
            ...
            <a href="<?php echo site_url('roomservice/roomservice/map?id='.$inter_id.'&hotel_id='.$hotel_id.'&shop_id='.$shop_id .(empty($addr_id)?'':'&addr_id='.$addr_id))?>" class="webkitbox justify input_item">
            	<span>所在地区</span>
...
<script>
    ...
    $(function(){
        ...
        $('#saveAddr').click(function(){
            ...
            $.post('<?php echo site_url('roomservice/roomservice/saveAddress');?>',{

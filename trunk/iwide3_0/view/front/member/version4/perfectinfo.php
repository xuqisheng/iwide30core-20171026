...
<?php 
//银座敏感信息加密处理
if ($inter_id=='a476756979'){
$centerinfo['cellphone']=substr_replace($centerinfo['cellphone'],'*****','3','5');
if (isset($centerinfo['id_card_no'])&&!empty($centerinfo['id_card_no'])){
$centerinfo['id_card_no']=substr_replace($centerinfo['id_card_no'],'**********','3','12');
}
}
?>
<body ontouchstart>
            ...
            <div class="weui_cells weui_cells_form">
                ...
                <div class="weui_cell name">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="<?php echo $modify_config['name']['type']; ?>" value="<?php if($centerinfo['name']!='微信用户'){echo $centerinfo['name'];} ?>" name="name" pattern="<?php echo $modify_config['name']['regular']; ?>"  placeholder="<?php echo $modify_config['name']['note']; ?>" <?php if ($inter_id=='a476756979'&&!empty($centerinfo['name'])){echo 'readonly';}?>/>
                    </div>
                ...
                <div class="weui_cell phone">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="<?php echo $modify_config['phone']['type']; ?>" value="<?php echo $centerinfo['cellphone'] ?>" name="phone" pattern="<?php echo $modify_config['phone']['regular']; ?>"  placeholder="<?php echo $modify_config['phone']['note']; ?>"<?php if ($inter_id=='a476756979'&&!empty($centerinfo['cellphone'])){echo ' disabled="disabled" ';}?> />
                    </div>
                    <div class="weui_cell_ft">
                        <i class="weui_icon_warn"></i>
                    </div>
                ...
                <div class="weui_cell idno">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="<?php echo $modify_config['idno']['type']; ?>" value="<?php echo $centerinfo['id_card_no'] ?>" pattern="<?php echo $modify_config['idno']['regular']; ?>"  placeholder="<?php echo $modify_config['idno']['note']; ?>" name="idno" <?php if ($inter_id=='a476756979'&&!empty($centerinfo['id_card_no'])){echo ' disabled="disabled" ';}?>/>
                    </div>
                    <div class="weui_cell_ft">
                        <i class="weui_icon_warn"></i>
                    </div>

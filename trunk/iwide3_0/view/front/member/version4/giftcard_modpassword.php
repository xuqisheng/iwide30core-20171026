...
<body>
<form id="update_password" action="<?php echo base_url("index.php/membervip/Giftcards/updatepasswordsave");?>" method="post">
<div class="ui_normal_list ui_border">
    ...
    <div class="item">
    	<tt>确认新密码</tt>
    	<input name="resetpassword" type="password" placeholder="请输入密码">
    </div>
</div>
...
$(document).ready(function(){
	  $('#sub').click(function(){
	       ...
	       if($("input[name='password']").val() != $("input[name='resetpassword']").val()) {
	        ...
	        var form = $("#update_password"),form_url=form.attr("action"),btn = $(this),loadtip=null;
	            ...
	            beforeSubmit: function(arr, $form, options){
	                ...
	                for(i in arr){
	                    ...
	                    if(name == 'oldpassword' && !value) {
	                        _null = true; _msg = '请输入原密码';inputobj=$("input[name='"+name+"']");break;
	                    }

...
<body ontouchstart>
    <div class="vip_content" style="display:none;">
        ...
        <!--FROM DATA START-->
        <form id="loginSave" action="<?php echo base_url("index.php/membervip/reg/do_activate");?>" method="post" >
            <input type="hidden" name="smstype" value="2" />
            <input type="hidden" name="card_code" value="<?php echo $card_code;?>" />
            <input type="hidden" name="card_id" value="<?php echo $card_id;?>" />
        <div class="bd spacing">
            <div class="weui_cells weui_cells_form">
                <?php if(isset($login_config['account']['show']) && $login_config['account']['show']){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['name']['show']) && $login_config['name']['show']){ ?>
                <div class="weui_cell name">
                ...
                <?php }?>
                <?php if(isset($login_config['sex']['show']) && $login_config['sex']['show']){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['phone']['show']) && $login_config['phone']['show']){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['password']['show']) && $login_config['password']['show'] ){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['email']['show']) && $login_config['email']['show']){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['idno']['show']) && $login_config['idno']['show']){ ?>
                ...
                <?php }?>
                <?php if(isset($login_config['phonesms']['show']) && $login_config['phonesms']['show']){  ?>
            ...
            <div class="bd spacing">
                <a href="javascript:;" class="weui_btn weui_btn_primary">激活</a>
            </div>
        </div>
        </form>
...
//                    resetForm:true,
                    beforeSubmit: function(arr, $form, options){
                        ...
                        loadtip = new AlertBox({content:'激活中',type:'loading',site:'topmid'}).show();
                    },
                    success: function(result){
                        ...
                        if(result.err>1){
                            ...
                            new AlertBox({content:result.msg,type:'tip',site:'bottom',time:100}).show();

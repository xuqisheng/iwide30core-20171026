...
<div class="vip_content" style="display:none;">
    ...
    <!--FROM DATA START-->
    <form id="loginSave" action="<?php echo base_url("index.php/membervip/wechatcard/login_activate_post?").$params;?>" method="post" >
    ...
    <div><br/>
        <div class="weui_cell">
            <div class="weui_cell_bd ">
                <a href="<?php echo base_url("index.php/membervip/wechatcard/reg_activate?").$params;?>" style="margin-left:3px;">注册激活</a>
            </div>
        </div>
    </div>
    <!--FROM DATA END-->

...
<body class="body" ontouchstart>
    <div class="vip_content j_con" >
        ...
        <form class="j_form" id="SavePayPassword" action="<?php echo base_url("index.php/membervip/balance/save_setpwd");?>" method="post"  >
           <div class="in_row">
              <p class="txt_code">支付密码:</p>
              <p class="txt_in"><input class="pay_co1" type="password" value="" name="password"></p>
           </div>
           <div class="in_row">
              <p class="txt_code">确认支付密码:</p>
    ...
    <div class="weui_dialog_alert j_flexd" id="dialog2" style="display: none;">
        ...
        <div class="weui_dialog">
            ...
            <div class="weui_dialog_ft">
                <a href="javascript:;" class="weui_btn_dialog primary" style="font-size:1.8rem;padding:3% 0;">确定</a>
            </div>
        </div>
    </div>
    <!--dialog end -->

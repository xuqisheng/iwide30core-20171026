...
<link href="<?php echo base_url("public/member/super8/css/index.css");?>" rel="stylesheet">
...
<div class="head">
    ...
    <div class="mask">
        ...
        <div class="item bod"></div>
    	<a href="<?php echo base_url("index.php/member/crecord/balances");?>" class="item">
        	<div><?php if(isset($member)) {echo intval($member->balance);} else {echo "0";}?></div>
            <div>我的现金券</div>
        </a>
        <div class="item bod"></div>

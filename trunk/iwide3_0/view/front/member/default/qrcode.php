...
<div class="fixe">
	<div class="er_log">
    	...
    	<div>卡号： <?php if($member->inter_id=='a421641095'):echo $member->membership_number;else: echo $member->mem_card_no;endif;?></div>
        <div id="Timer">00:00:00</div>
    </div>
    <div class="erwen_b">
        <img src="<?php echo base_url("public/member/public/images/fen_bg_1.png");?>">
        <?php if($member->inter_id=='a421641095'):?>
        <img src="<?php echo base_url("index.php/member/qrcodecon?data=MEM").$member->membership_number;?>">
        <?php else:?>
        <img src="<?php echo base_url("index.php/member/qrcodecon?data=").$member->mem_card_no;?>">
        <?php endif;?>
    </div>
</div>
</body>

...
<div class="ui_normal_list ui_border">
    ...
    <?php if(isset($fields['oldpassword']) && ($fields['oldpassword']['must']==1)) {?>
    <div class="item">
    	<tt><?php echo $fields['oldpassword']['name'];?></tt>
    	<input name="oldpassword" type="text" placeholder="请输入<?php echo $fields['oldpassword']['name'];?>" value="<?php if(isset($member)) echo $member->oldpassword;?>">
    </div>
    <?php } ?>

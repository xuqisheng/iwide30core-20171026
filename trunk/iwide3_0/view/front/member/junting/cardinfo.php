...
<div class="ticket">
    ...
    <?php if(!empty($card_info) && $my_card === true){ ?>
	<div class="t_img"><img src="<?=isset($card_info['logo_url'])?$card_info['logo_url']:'';?>"/></div>
	<div class="con_list">
		<div class="c_868">卡券名称</div>
		<div class="c_l_c ellipsis"><?php echo $card_info['title'] ?></div>
	</div>
    <div class="con_list">
        <div class="c_868">券码</div>
        <div class="c_l_c ellipsis"><?php echo $card_info['coupon_code'] ?></div>
    </div>
    <div class="con_list">
        <div class="c_868">使用提醒</div>
        <div class="c_l_c" ><?php echo $card_info['notice'] ?></div>
    </div>
	<div class="con_list">
		<div class="c_868">使用说明</div>
		<div class="c_l_c" ><?php echo $card_info['description'] ?></div>
	</div>
	<div class="con_list">
		<div class="c_868">有效期</div>
		<div class="c_l_c ellipsis">
            <?php if($card_info['use_time_end_model']=='y'):?>
                <?php echo date('Y.m.d',$card_info['receive_time']); ?>至
                <?php echo date('Y.m.d',$card_info['expire_time']); ?>
            <?php elseif ($card_info['use_time_end_model']=='g'):?>
        ...
        <div class="bd spacing">
            <div class="weui_cells weui_cells_form">
                ...
                <div class="weui_cell account">
                    <img src="<?=!empty($qrcodecon_url)?"{$qrcodecon_url}&margin=10&data={$card_info['coupon_code']}":''?>"  style="max-width: 220px" />
                </div>
                <div class="weui_cell_bd">
...
<div id="actionSheet_wrap" style="display:none;" >
    ...
    <div class="weui_actionsheet weui_actionsheet_toggle" id="weui_actionsheet">
        <div class="weui_actionsheet_menu">
            <?php if(isset($card_info['header_url'])){ ?>
                    <div class="weui_actionsheet_cell"><a href="<?php echo $card_info['header_url']; ?>" style="display: block">立即使用</a></div>
            <?php } ?>
            <?php if(isset($card_info['hotel_header_url'])){ ?>
                     <div class="weui_actionsheet_cell"><a href="<?php echo $card_info['hotel_header_url']; ?>"  style="display: block">去订房</a></div>
            <?php } ?>
            <?php if(isset($card_info['shop_header_url'])){ ?>
                     <div class="weui_actionsheet_cell"><a href="<?php echo $card_info['shop_header_url']; ?>"  style="display: block">去商城</a></div>
            <?php } ?>
            <?php if(isset($card_info['soma_header_url'])){ ?>
                     <div class="weui_actionsheet_cell"><a href="<?php echo $card_info['soma_header_url']; ?>"  style="display: block">去团购</a></div>
            <?php } ?>
        </div>

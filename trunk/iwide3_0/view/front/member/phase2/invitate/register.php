...
<head>
	...
	<title><?=!empty($view_conf['reg_login']['reg_title'])?$view_conf['reg_login']['reg_title']:'邀请好友-注册'?></title>
...
<body>
        ...
        <form id="fomr_con" class="fomr_con" action="<?php echo $save_url;?>" method="post" >
            ...
            <div class="kuang">
            <?php foreach ($reg_conf as $key => $item):?>
        ...
        <div class="xuanxiang">已是会员？<span><a href="<?php echo EA_const_url::inst()->get_url('*/*/login',array('id'=>$inter_id,'share_key'=>$code));?>">马上登录</a></span></div>
    ...
    $(function(){
        ...
        $(".send_code").click(function(){
            if(sendto==1){
                ...
                new AlertBox({content:'请在'+numbe+'秒后点击获取',type:'tip',site:'bottom'}).show();
            }
            sendto = 0;
            autopay_time();
        });

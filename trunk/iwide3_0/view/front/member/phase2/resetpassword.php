...
<body ontouchstart>
    <div class="vip_content" style="display:none;">
        ...
        <!--FROM DATA START-->
        <form id="loginSave" action="<?php echo base_url("index.php/membervip/resetpassword/saveresetpassword");?>" method="post" >
        ...
        <div class="bd spacing">
            <div class="weui_cells weui_cells_form">
                ...
                <div class="weui_cell email">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="<?php echo $login_config['email']['type']; ?>" name="email" pattern="<?php echo $login_config['email']['regular']; ?>"  placeholder="<?php echo $login_config['email']['note']; ?>"/>
                    </div>
                    <div class="weui_cell_ft">
                        <i class="weui_icon_warn"></i>
                    </div>
                ...
                <div class="weui_cell password">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="<?php echo $login_config['password']['type']; ?>" name="password" pattern="<?php echo $login_config['password']['regular']; ?>"  placeholder="<?php echo $login_config['password']['note']; ?>"/>
                    </div>
                    <div class="weui_cell_ft">
                        <i class="weui_icon_warn"></i>
                    </div>
            ...
            <div class="bd spacing">
                <a href="javascript:;" style="background-color:#316f4d;" class="weui_btn weui_btn_primary">提交</a>
            </div>
        </div>
        </form>

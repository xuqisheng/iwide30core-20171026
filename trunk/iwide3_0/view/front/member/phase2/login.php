...
//                    resetForm:true,
                ...
                success: function(result){
                    removeload();
                    if(result.err == '2018'){
                   	 $.MsgBox.Confirm(result.msg,function(){var locat_url = '<?php echo site_url('membervip/reg').'?redir='.$redir;?>';window.location.href=locat_url},'','注册','取消')
                        ...
                        $.MsgBox.Alert(result.msg,function(){var locat_url = '<?php echo $succ_url;?>';window.location.href=locat_url;});
                    }
                },
                error:function () {
                    removeload();

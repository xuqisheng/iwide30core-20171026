    ...
    <div class="vip_content" style="display:none;">
        <div class="weui_msg">
           ...
           <div class="weui_text_area">
               ...
               <p class="weui_msg_desc">支付成功,请在我的<?php echo $this->_ci_cached_vars['filed_name']['balance_name'];?>查看</p>
           </div>
           <div class="weui_opr_area">
            ...
            <div class="weui_opr_area">
                <img src="<?php echo base_url("public/member/yasite/yasite_qrc.jpg");?>"/>
            </div>

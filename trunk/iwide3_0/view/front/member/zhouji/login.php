...
<title><?php echo $inter_id=='a491796658'? '绑定':'登录'?></title>
</head>
<body>
...
<form id="loginSave" action="<?php echo base_url("index.php/membervip/login/savelogin");?>" method="post" >
    ...
    <div class="sign_btn bg_main"><?php echo $inter_id=='a491796658'? '绑定':'登录'?></div>
    <div class="sign_list">
    <?php if($inter_id!='a486201893'&&$inter_id!='a491796658'){?>
        <a class="f_r" href="<?php echo base_url("index.php/membervip/resetpassword");?>">忘记密码?</a>
        <?php }?>
        <a href="<?php echo base_url("index.php/membervip/reg");?>">注册账户</a>
    </div>
</form>
<!--dialog end -->

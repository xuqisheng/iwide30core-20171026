...
<div class="use_coupon">
    ...
    <div class="bg_fff use_coupo_txt">
        ...
        <div class="multi_line">
            <?php if($my_card === true && $card_info['pms_card_sno_show'] === true):?>
            <div class="m_line_con">
                <div>券码:</div>
                <div><?=$card_info['pms_card_sno']?></div>
            </div>
            <?php endif;?>
            <div class="m_line_con">
                <div>使用说明:</div>
                <div><?=str_replace(array('；',';'), '.<br/>', $card_info['remark'])?></div>
            </div>
            <div class="m_line_con">
                <div>可用时间:</div>
                    <?php echo date('Y.m.d',$card_info['use_time_start']); ?>-<?php echo date('Y.m.d',$card_info['expire_time']); ?>
                </div>
            </div>
        </div>
        <?php if($card_info['is_active']=='t' && $my_card === true):?>

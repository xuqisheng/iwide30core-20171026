    ...
    <div class="bg_fff use_coupo_txt">
        ...
        <div class="single">
            ...
            <?php if($card_info['is_active']=='t'):?>
                ...
                <div>转赠中</div>
                <?php endif;?>
                <?php if(!empty($card_info['is_can_give_friend']) && $card_info['is_can_give_friend']=='t' && $card_info['is_giving']=='t' && $user['member_info_id'] != $gift_mem_info['member_info_id']):?>
        ...
        $('#action_receive').one('click',function(){//防止多次请求，只绑定一次
            ...
            $.post(post_url,{ec_code:ec_code},function(data){
                ...
                if(data.err>0){
                    ...
                    var jump_url = "<?=!empty($cardcenter_url)?$cardcenter_url:''?>";

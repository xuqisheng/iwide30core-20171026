...
<title>会员中心</title>
<style type="text/css">
    /*.bg_l_g_fec50f_ffa70a{background: -webkit-linear-gradient(left top,#ff980e,#ff980e);}*/
</style>
</head>
<body>
...
<?php if($centerinfo['value']=="login"){ ?>
	...
	<?php }else{ ?>
        <div class="btn_list h26">
            <a class="color_fff" href="<?php echo base_url("index.php/membervip/login");?>"><?php  echo $inter_id=='a492669988'? '绑定':'登录'?></a> |
...
<?php } ?>
    ...
    <div class="display_flex number_list">
        <a href="<?php echo base_url("index.php/membervip/balance?credit_type=1");?>" class="number_con">
        ...
        <a href="<?php echo base_url("index.php/membervip/bonus?credit_type=1");?>" class="number_con">
            <p><?php if($centerinfo['value']=="login" && $centerinfo['member_mode'] ==1&&$inter_id!='a492669988' ){ echo '-';}else{ echo $centerinfo['credit']; } ?></p>
        ...
        <a href="<?=!empty($card_url)?$card_url:base_url("index.php/membervip/card");?>" class="number_con">
            ...
            <p class="color_fff"><?php echo $this->_ci_cached_vars['filed_name']['coupon_name'];?></p>
        </a>
    </div>
</div>

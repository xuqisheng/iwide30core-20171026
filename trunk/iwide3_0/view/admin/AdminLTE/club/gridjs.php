...
$('#data-grid tbody').on('click', 'tr', function(){
	...
	if(selected.length==1){
        ...
        $('#grid-btn-edit2').removeClass('disabled').bind('click', selected, function(ev){
        window.location= url_edit2+ '?ids='+ ev.data;
        });
        $('#grid-btn-edit3').removeClass('disabled').bind('click', selected, function(ev){
        window.location= url_edit3+ '?ids='+ ev.data;
        });

        $('#open-fans').removeClass('disabled').bind('click', selected, function(ev){
        window.location= open_fans+ '&ids='+ ev.data;
        });

        $('#close-fans').removeClass('disabled').bind('click', selected, function(ev){
        window.location= close_fans+ '&ids='+ ev.data;
        });
        ...
        $('#grid-btn-edit2').addClass('bg-green');
        $('#grid-btn-edit3').addClass('bg-green');
        $('#open-fans').addClass('bg-green');
        $('#close-fans').addClass('bg-green');
        ...
        $('#grid-btn-edit2').addClass('disabled').removeClass('bg-green').unbind();
        $('#grid-btn-edit3').addClass('disabled').removeClass('bg-green').unbind();
        $('#open-fans').addClass('disabled').removeClass('bg-green').unbind();
        $('#close-fans').addClass('disabled').removeClass('bg-green').unbind();

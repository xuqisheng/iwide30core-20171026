...
$buttions.= '<button type="button" class="btn btn-sm disabled" id="grid-btn-edit"><i class="fa fa-edit"></i>&nbsp;编辑属性</button>';
...
var url_edit= '<?php echo EA_const_url::inst()->get_url("*/*/editattribute"); ?>';		//跟button对应

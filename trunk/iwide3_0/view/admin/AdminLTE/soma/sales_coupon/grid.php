...
$buttions.= '<button type="button" class="btn btn-sm bg-green" id="grid-btn-add"><i class="fa fa-refresh"></i>&nbsp;同步优惠券</button>';
...
var url_add= '<?php echo EA_const_url::inst()->get_url("*/*/refresh"); ?>';			//跟button对应

...
var url_ajax= '<?php echo Soma_const_url::inst()->get_url("*/*/*", $this->input->get('filter')); ?>';
...
if( count($result['data'])<$num || $search == 1){
    if( $module ) $m= $module;
    else $m= 'privilege';
    $gridjs= VIEWPATH. $tpl .DS . $m. DS. 'sales_order/gridjs.php';
    ...
    $gridjs= VIEWPATH. $tpl .DS . $m. DS. 'sales_order/gridjs_ajax.php';
    if( file_exists($gridjs) )
        require_once $gridjs;
    else 

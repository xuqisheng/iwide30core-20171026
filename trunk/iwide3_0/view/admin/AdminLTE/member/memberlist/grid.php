...
$buttions.= '<button type="button" class="btn btn-default disabled" id="grid-btn-edit"><i class="fa fa-edit"></i>&nbsp;查看</button>';

if($inter_id=='a450682197'){
    $buttions.= '<button type="button" class="btn btn-default disabled" id="grid-btn-bind" style="margin-left: 10px"><i class="fa fa-edit"></i>&nbsp;解绑</button>';
}
...
if( count($result['data'])<$num)
	require_once VIEWPATH. $tpl .DS .'member'.DS.'memberlist'. DS. 'gridjs.php';
else
	require_once VIEWPATH. $tpl .DS .'member'.DS.'memberlist'. DS. 'gridjs_ajax.php';
?>
});
</script>
</body>

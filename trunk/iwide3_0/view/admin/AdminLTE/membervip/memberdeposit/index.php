...
<script type="text/javascript">
    <?php
    $sort_index= $module->field_index_in_grid($default_sort['field'],12);
...
if( floatval($result['total'])<$num)
    require_once VIEWPATH. $tpl .DS .'membervip'. DS. 'memberdeposit'. DS .'indexjs.php';
else
    require_once VIEWPATH. $tpl .DS .'membervip'. DS. 'memberdeposit'. DS. 'indexjs_ajax.php';
?>
<script type="text/javascript">
$(function () {
        ...
        $(document).on('click','.deposit-export',function () {
            ...
            art.dialog({
                ...
                ok:function (){
                    ...
                    window.location= url_action+'?tp=7&bt='+start_time+'&et='+end_time;
                },
                cancel:true,
                follow:onthis,
                okVal:'导出',

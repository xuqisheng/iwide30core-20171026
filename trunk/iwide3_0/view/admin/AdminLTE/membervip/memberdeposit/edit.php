	...
	<div class="box-body">
        <table class="table table-bordered table-striped table-condensed dataTable no-footer">
            ...
            <thead>
                <?php foreach ($deposit as $key => $value) { ?>
                    <tr>
                        <td> <?php echo $value['balance_log_id'] ?> </td>
                        ...
                        <td> <?php echo $value['note']?$value['note']:"未填写" ?> </td>
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-default ">
                <a href="<?php echo EA_const_url::inst()->get_url('*/*/index?last_balance_log_id=').$last_balance_log_id; ?>">
                    <i class="fa fa-edit"></i>&nbsp;
                    <?php if($last_balance_log_id){ ?>
                        下一页
                    <?php }else{ ?>
                        第一页
                    <?php } ?>

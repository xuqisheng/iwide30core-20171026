...
<div class="content-wrapper">
	<header class="headtitle">新增店铺</header>
    <section class="content">
<?php echo $this->session->show_put_msg(); ?>
<?php //$pk= $model->table_primary_key(); ?>
<?php if(isset($id)){?>
<?php echo form_open('appointment/restaurant/edit?ids='.$id,array('id'=>'tosave','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }else{?>
    ...
    <div class="bd_left list_layout">
        <div required>
            ...
            <div class="flex flexcenter">
                <label class="check"><input name="shop_status" type="radio" value="1" checked/><span class="diyradio"><tt></tt></span>是</label>
                <label class="check"><input name="shop_status" type="radio" value="2" /><span class="diyradio"><tt></tt></span>否</label>
            </div>
        </div>
        ...
        <div required>
            <div>预约方式</div>
            <div class="flex flexcenter">
                <label class="check"><input name="book_style" type="radio" value="1" checked/><span class="diyradio"><tt></tt></span>取号+预订</label>
                <label class="check"><input name="book_style" type="radio" value="2" /><span class="diyradio"><tt></tt></span>仅取号</label>
                <label class="check"><input name="book_style" type="radio" value="3" /><span class="diyradio"><tt></tt></span>仅预订</label>
            </div>
        </div>
    </div>
</div>
...
<div class="whitetable">
    ...
    <div class="bd_left list_layout">
        <div style="padding-bottom:0" required>
        	...
        	<div class="layoutfoot" style="color:inherit;display:none" id="RangeTable" limit='8'>
...
<!--                    	<div>等待时长</div>-->
                    ...
                    <!--div class="tr">
                        <div><input class="input xs" onChange="" value="" /></div>
                        <div><input class="input xs" onChange="" value="" /> - <input class="input xs" onChange="" value="" /></div>
                        <div><input class="input xs" onChange="" value="" /> 分钟/桌</div>
...
<div class="whitetable">
    ...
    <div class="bd_left list_layout">
        <div style="padding-bottom:0" required>
        	...
        	<div class="layoutfoot" style="color:inherit; display:none" id="TypeTable" limit='8'>
...
<div class="whitetable">
    ...
    <div class="bd_left list_layout">
        <div required>
            <div>类型单位</div>
            <div class="input flexgrow"><input name="unit" required placeholder="如：桌、台" value=""></div>
        </div>
        <div required>
            <div>人数上限</div>
            <div class="input flexgrow"><input name="toplimit" required placeholder="输入最大可预约/预订容纳人数" value=""><span>人</span></div>
        </div>
    </div>
</div>
    ...
    <div class="bd_left list_layout">
        <div required>
            ...
            <div class="flex flexcenter" style="max-width:100%;">
            	<div>营业前&nbsp;</div>
                <div class="input"><input name="start_time" required value="" style="width:80px"></div>
                <div>&nbsp;分钟可取号，结业前&nbsp;</div>
                <div class="input"><input name="end_time" required value="" style="width:80px"></div>
                <div>&nbsp;分钟关闭取号</div>
            </div>
        </div>
        <div>
            <div class="flex_aligntop">取号备注</div>
            <div class="flexgrow input"><textarea name="give_info" maxlength="120"></textarea></div>
        </div>
    </div>
</div>
...
<div class="whitetable" id="only_booked">
    ...
    <div class="bd_left list_layout">
        <div required>
            ...
            <div class="flex flexcenter" style="max-width:100%;">
            	<div>可提前&nbsp;</div>
                <div class="input"><input required name="book_day" placeholder="" value="" style="width:80px"><span>天</span></div>
                <div>&nbsp;预订</div>
            </div>
        </div>
        <!----------- 暂不开发
...
<div class="whitetable">
    ...
    <div class="bd_left list_layout">
        <div required>
            <div>店铺电话</div>
            <div class="input flexgrow"><input required name="shop_tel" value=""></div>
        </div>
        <div required>
            <div>店铺地址</div>
            <div class="input flexgrow"><input required name="shop_address" value=""></div>
        </div>
        <div>
            <div>模板消息通知</div>
            <div class="select_input flexgrow">
        ...
        <div required>
            ...
            <div class="flexgrow flex">
                <div class="input maright "><input required class="timepicker" name="start_open_time" value=""></div>
                <span>-</span>
                <div class="input"><input required class="timepicker" name="end_open_time" value=""></div>
            </div>
        </div>
        -->
        <div>
            <div class="flex_aligntop">店铺简介</div>
            <div class="flexgrow input"><textarea name="shop_profiles" maxlength=""></textarea></div>
        </div>
    </div>
    ...
    <div class="bd_left list_layout">
        <div required>
            <div>缩略图</div>
            <div>
                <input type="hidden" required name="shop_image" id="el_shop_img" value=''>
...
function show_book_type(){
	...
	$('#only_booked').show();
	$('#only_getnum').show();
    $('#only_booked input,#only_getnum input').attr('required','true');
	if(val == 2)
    {
		$('#only_booked').hide();
        $('#only_getnum input').attr('required','true');
		$('#only_booked input').removeAttr('required');
	}
    else if(val==3)
    {
		$('#only_getnum').hide();
        $('#only_booked input').attr('required','true');
        $('#only_getnum input').removeAttr('required');
	}
}

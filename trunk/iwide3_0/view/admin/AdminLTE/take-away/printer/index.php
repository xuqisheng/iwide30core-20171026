        ...
        <div class="content-wrapper" style="min-width:1130px;" >
            ...
            <div class="contents">
                <div class="hottel_name ">
                    ...
                    <div class="input_txt">
                        <form id="" action="<?php echo site_url('take-away/printer/index');?>" class="form-inline" method="get">
                        ...
                        <input type="submit" class="btn bg_ff9900 color_fff" value="检索"/>&nbsp;&nbsp;&nbsp;
                         <a href="<?php echo site_url('take-away/printer/add')?>" class="btn btn-sm bg-green">新增打印机
                         </a>
                        </form>
                    </div>
                </div>
                        ...
                        <tr class="bg_f8f9fb form_title">
                           ...
                           ?>
                             <tr class=" form_con">
                                ...
                                <td><a class="color_72afd2" href="<?php echo site_url('take-away/printer/edit?ids='.$v['id'])?>">编辑</a>
                                    <?php if($v['status'] == 1){?>
...
// 	  modal.find('.modal-body input').val(recipient)
    ...
    function change_staus(id,status){
        ...
        $.post('<?php echo site_url('take-away/printer/change_status')?>',{
            'id':id,
            'status':status,

          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <!-- 
                ...
                <div class="row">
                	<div class="col-sm-12">
                	<?php echo form_open('hotel/hotel_report/order_rn',array('class'=>'form-inline','id'=>'para_form'));?>
...
function out_port(){
	location.href='<?php echo site_url("hotel/hotel_report/ext_order_rn").'?'?>'+$('#para_form').serialize();
}

				...
				<div class="contents_list bg_fff">
					...
					<div class="con_right">
						...
						<div class="hotel_star">
							<div class="">入住日期</div>
							<div class="w_550">
    							<i class="iconfont symbol">&#xe672;</i><input name="s_date_s" id="datepicker" class="datepicker j_inupt" type="text" value="<?php if(isset($list['use_condition']['s_date_s']))echo $list['use_condition']['s_date_s']; ?>"/>
    							<select name='s_date_m' style='width: 4em'>
									<option value="1" <?php if (empty($list['use_condition']['s_date_m'])||$list['use_condition']['s_date_m']==1){?>selected<?php }?>>且</option>
									<option value="2" <?php if (!empty($list['use_condition']['s_date_m'])&&$list['use_condition']['s_date_m']==2){?>selected<?php }?>>或</option>
    							</select>
    							<i class="iconfont symbol">&#xe612;</i><input name="s_date_e" id="datepicker2" class="datepicker j_inupt m_r_2" type="text" value="<?php if(isset($list['use_condition']['s_date_e']))echo $list['use_condition']['s_date_e']; ?>"/>
    							方可预定
							</div>
						</div>
						<div class="address">
							<div class="">离店日期</div>
							<div class="w_550">
    							<i class="iconfont symbol">&#xe672;</i><input name="e_date_s" id="datepicker3" class="datepicker j_inupt" type="text" value="<?php if(isset($list['use_condition']['e_date_s']))echo $list['use_condition']['e_date_s']; ?>"/>
    							<select name='e_date_m' style='width: 4em'>
									<option value="1" <?php if (empty($list['use_condition']['e_date_m'])||$list['use_condition']['e_date_m']==1){?>selected<?php }?>>且</option>
									<option value="2" <?php if (!empty($list['use_condition']['e_date_m'])&&$list['use_condition']['e_date_m']==2){?>selected<?php }?>>或</option>
    							</select>
    							<i class="iconfont symbol">&#xe612;</i><input name="e_date_e" id="datepicker4" class="datepicker j_inupt m_r_2"  type="text" value="<?php if(isset($list['use_condition']['e_date_e']))echo $list['use_condition']['e_date_e']; ?>"/>
    							方可预定
    						</div>
						</div>
						<div class="address">

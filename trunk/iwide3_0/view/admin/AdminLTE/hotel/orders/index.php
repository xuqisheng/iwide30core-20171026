            ...
            <div class="contents">
				...
				<div class="head_cont contents_list bg_fff">
					<div class="j_head">
						...
						<div>
							...
							<span class="t_time"><input name="start_t" type="text" id="datepicker" class="datepicker moba" value="<?php echo $start_t;?>" placeHolder='不填为不限'></span>
                            <font>至</font>
                            <span class="t_time"><input name="end_t" type="text" id="datepicker2" class="datepicker moba" value="<?php echo $end_t;?>" placeHolder='不填为不限'></span>
						</div>
						<div>
							<span>关键字</span>
				...
				<div class="contents_list bg_fff" style="font-size:13px;">
					<div class="p_r_30 classification b_b_1">
						...
						<div class="<?php if($istatus==$k){echo 'add_active';}?>"><a href="<?php echo site_url('hotel/orders/index?s='.$k);?>"><?php echo $v['des'];if (!$no_count_order||$v['count']){?><font>(<?php echo $v['count'];?>)<?php }?></font></a></div>
						<?php }?>
					</div>

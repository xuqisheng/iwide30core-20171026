...
//$buttions.= '<button type="button" class="btn btn-sm disabled single-btn" id="grid-btn-extra-0" target="qr"><i class="fa fa-qrcode"></i>&nbsp;二维码</button>';
$buttions.= '<button id="qrcode_btn" data-target="#myModal" data-toggle="modal" type="button" class="btn btn-sm disabled single-btn" ><i class="fa fa-qrcode"></i>&nbsp;二维码</button>';

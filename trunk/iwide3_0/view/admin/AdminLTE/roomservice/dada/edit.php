...
<?php if(isset($id)){?>
<?php echo form_open('roomservice/dada/edit?ids='.$id,array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data' ))?>
<?php }else{?>
<?php echo form_open('roomservice/dada/add',array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }?>

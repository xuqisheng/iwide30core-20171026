...
<section class="content">
  <div class="row">
	<div class="col-xs-12">
	  ...
	  订单时间
      <input id="qingfeng1" name="timedown" type="text" value="<?php echo $condition['timedown'];?>" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'qingfeng2\')||\'2020-10-01\'}'})" style="width:100px" /> 
      <input id="qingfeng2" name="timeup" type="text" value="<?php echo $condition['timeup'];?>" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'qingfeng1\')}',maxDate:'2020-10-01'})" style="width:100px" />
	  ...
	  <input type="submit" name="Submit" value="提交">
		  ...
		  <div id="main" style="height:400px; width:100%"></div>
			...
			</div><div class="col-sm-7"></div></div></div>
		</div><!-- /.box-body -->
	  </div><!-- /.box -->
	</div><!-- /.col -->
  </div><!-- /.row -->

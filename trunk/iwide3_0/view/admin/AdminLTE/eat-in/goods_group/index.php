        ...
        <div class="content-wrapper" style="min-width:1130px;" >
            ...
            <div class="contents">
                <div class="hottel_name ">
                    ...
                    <div class="input_txt">
                        <form id="" action="<?php echo site_url('eat-in/goods_group/index')?>" class="form-inline" method="get">
                        ...
                        <input type="submit" class="btn " value="检索"/>&nbsp;&nbsp;&nbsp;
                         <a href="<?php echo site_url('eat-in/goods_group/add')?>" class="btn btn-sm bg-green">新增分组</a>
                        </form>
                    </div>
                </div>
                    ...
                    <table id="coupons_table" class="table-striped table-condensed dataTable no-footer" style="width:100%;">
                       ...
                       ?>
                          <tr class=" form_con">
                            ...
                            <td><a  class="color_72afd2" href="<?php echo site_url('eat-in/goods_group/edit?ids='.$v['group_id'])?>">编辑</a>
...
// 	  modal.find('.modal-body input').val(recipient)
    ...
    function del_group(group_id,shop_id){
        ...
        $.post('<?php echo site_url('eat-in/goods_group/del_group')?>',{
            'group_id':group_id,
            'shop_id':shop_id,
    ...
    $(document).ready(function() {
        ...
        $('#output').click(function(){
            ...
            //url = "<?php echo site_url('eat-in/qrcodelist/output_qrcode')?>"+"?s="+tmp;
            //alert(url);return false;
            location.href="<?php echo site_url('eat-in/qrcodelist/output_qrcode')?>"+"?s="+tmp;
        });
    });
</script>
</body>

                ...
                <div class="hottel_name ">
                    ...
                    <div class="input_txt">
                        ...
                        <input type="submit" class="btn bg_ff9900 color_fff" value="检索"/>&nbsp;&nbsp;&nbsp;
                         <a href="<?php echo site_url('ticket/shop/add')?>" class="btn btn-sm bg-green">新增店铺</a>
                        </form>
                    </div>
                </div>
                        ...
                        <tr class="bg_f8f9fb form_title">
                           ...
                           ?>
                             <tr class=" form_con">
                                ...
                                <td><a class="color_72afd2" href="<?php echo site_url('ticket/shop/edit?ids='.$v['shop_id'])?>">编辑</a>
                                    <?php if($v['status'] == 1){?>

        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-sm-12">
                  <?php echo form_open('okpay/statistics/detail','class="form-inline"')?>
            ...
            <table id="data-grid" class="table table-bordered table-striped table-condensed">
              ...
              <tr role="row">
                ...
                <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">场景数量</th>
                ...
                <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">交易笔数</th>
                <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">交易金额</th>
                <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">优惠笔数</th>
                <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">优惠金额</th>
                  <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">成功笔数</th>
                  ...
                  <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">退款笔数</th>
                  <th width="5%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label=": activate to sort column ascending">退款金额</th>
              ...
              foreach ( $res as $ii=>$item2 ):?>
                <tr>
                  ...
                  <td><?=isset($pubs[$item2['inter_id']]['name'])?$pubs[$item2['inter_id']]['name']:'--'?></td>
                  <td><?=$item2['type']?></td>
                  <td><?=$item2['all_mem']?></td>
                  <td><?=$item2['all_order']?></td>
                  <td><?=$item2['trade_money']?></td>
                  <td><?=$item2['discount_order']?></td>
                  <td><?=$item2['discount_money']?></td>
                    <td><?=$item2['success_order']?></td>
                    <td><?=$item2['success_money']?></td>
                    <td><?=$item2['cancel_order']?></td>
                    <td><?=$item2['cancel_money']?></td>
                    <td><?=empty($item2['all_order'])?0:number_format($item2['success_order'] / $item2['all_order'],4,'.','')*100 . '%'?></td>
                </tr>
              <?php endforeach;?>
              </tbody>
            </table>

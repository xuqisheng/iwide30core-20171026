...
<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title"><?php echo ( $this->input->post($pk) ) ? '新增': '订单'; ?>信息</h3>
	</div>
	<!-- /.box-header -->
<!-- form start -->
	<?php 
	echo form_open( EA_const_url::inst()->get_url('*/*/edit_post'), array('class'=>'form-horizontal'), array($pk=>$model->m_get($pk) ) ); ?>
		<div class="box-body">
            ...
            <div class="box-footer ">
                <div class="col-sm-4">
                    <a href="<?php echo site_url('okpay/orders/edit?ids='.$model->m_get('id').'&print=1')?>" class="btn btn-info pull-right">打印订单</a>
                </div>
            </div>
<!-- 

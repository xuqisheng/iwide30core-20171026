...
$buttions.= '<button type="button" class="btn btn-sm " id="grid-btn-minus"><i class="fa fa-minus"></i>&nbsp;退款</button>';
$buttions.= '<button type="button" class="btn btn-sm disabled" id="grid-btn-edit"><i class="fa fa-edit"></i>&nbsp;查看订单</button>';
$buttions.='<button type="button" class="btn btn-sm bg-green" id="grid_btn_export_report"><i class="fa fa-bar-chart"></i>&nbsp;导出</button>';
...
//执行导出数据
$("#grid_btn_export_report").bind("click",function(){
	window.open('<?php echo site_url("okpay/orders/ext_okpay_orders_report/")?>');
});

...
$buttions.= '<button type="button" class="btn btn-sm bg-green" id="grid-btn-add"><i class="fa fa-plus"></i>&nbsp;新增合作单位</button>';
...
$buttions.= '<button type="button" class="btn btn-sm disabled" style="margin-left:5px" id="grid-btn-edit2"><i class="fa fa-edit"></i>&nbsp;编辑公司协议价</button>';

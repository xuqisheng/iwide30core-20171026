...
$buttions.= '<button type="button" class="btn btn-sm disabled"  style="margin-left:5px" id="grid-btn-edit2"><i class="fa fa-edit"></i>&nbsp;查看员工</button>';
//$buttions.= '<button type="button" class="btn btn-sm disabled" style="margin-left:5px" id="grid-btn-edit3"><i class="fa fa-edit"></i>&nbsp;二维码</button>';
...
var url_add= '<?php
                        if($this->input->get('ids')){
                            echo EA_const_url::inst()->get_url("*/*/add").'?ads='.$this->input->get('ids');
                        }else{
                            echo EA_const_url::inst()->get_url("*/*/add");
                        }
?>';			//跟button对应
...
var url_edit2= '<?php echo '../staff/s_list'; ?>';		//跟button对应
var url_edit3= '<?php echo ''; ?>';		//跟button对应
<?php /* 有更多的按钮，URL在此定义，与上面button顺序匹配 */ ?>
var url_extra= [
    '<?php echo EA_const_url::inst()->get_url("*/*/qrcode_front"); ?>'
];
...
<?php if(isset($js_filter)) echo $js_filter; ?>
    ...
    $('#qrcode_btn').click(function(){
        var base_url= '<?php echo EA_const_url::inst()->get_url("*/*/qrcode_front"); ?>?ids=';

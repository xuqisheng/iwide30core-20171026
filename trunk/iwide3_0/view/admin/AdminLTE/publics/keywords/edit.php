		                ...
		                <div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<a class='default_keyword' title='扫描分销员二维码时总会推送此消息(需分销员状态为正常且参与分销，会覆盖该二维码对应关键字)，当类型为图文消息时，会自动将图文链接带上分销员id(可用于做推荐购买)，你亦可在链接上传入分销号(SALERID)和分销员酒店id(SALERHOTEL)，如saler=SALERID&hotel=SALERHOTEL' href="javascript:void(0)">分销二维码扫描推送</a>
								</div>
							</div>
							 <div class="form-group">

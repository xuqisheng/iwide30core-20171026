...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function refund($inputObj,$key_file,$cert_file,$mch_key,$timeOut = 6)
	{
		...
		$xml = $inputObj->ToXml();
		$startTimeStamp = self::getMillisecond();//请求开始时间
		$response = self::postXmlCurl($xml, $url, true,$key_file,$cert_file, $timeOut);
	 ...
	 * @throws WxPayException
	 */
	public static function reverse($inputObj,$key_file,$cert_file,$mch_key, $timeOut = 6)
	{
	 ...
	 * @throws WxPayException
	 */
	private static function postXmlCurl($xml, $url, $useCert = false,$key_file,$cert_file, $second = 30)
	{		
		$ch = curl_init();
		//设置超时

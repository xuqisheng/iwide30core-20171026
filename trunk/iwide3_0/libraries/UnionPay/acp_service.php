...
class AcpService {
	 ...
	 * @return 是否成功
	 */
	static function sign(&$params, $cert_path='', $cert_pwd='000000') {
		$cert_path=UnionPayConfig::getSignCertPath();
		$cert_pwd=UnionPayConfig::getSignCertPwd();
...
eot;
	 ...
	 * @return unknown
	 */
	static function decryptData($data, $cert_path='', $cert_pwd='000000') {
		$cert_path=UnionPayConfig::getSignCertPath();
		$cert_pwd=UnionPayConfig::getSignCertPwd();

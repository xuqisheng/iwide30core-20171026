...
class Perfectinfo extends MY_Front_Wxapp
{
	...
	public function index()
	{
        ...
        $this->out_put_msg ( 1, '', $data ,'member/perfectinfo');
	...
	public function save()
	{
		...
		$member = $this->imember->getMemberByOpenId($openid,$this->inter_id,0);
		 ...
		 if(!$member || !isset($member->mem_id)) {
		  	$this->out_put_msg ( 2, '保存信息有误' ,'','member/perfectinfo/save');
			//redirect('member/center');
			return;
		} 
		...
		//完善资料送券   START
			...
			$this->out_put_msg ( 1, '保存成功','' ,'member/perfectinfo/save');
		//完善资料送券   END

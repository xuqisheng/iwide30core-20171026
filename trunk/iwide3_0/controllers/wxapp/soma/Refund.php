...
//   var_dump($sales_order_model);exit;
    ...
    public function detail(){
        ...
        $data['refund_recv'] = '原路退回';//isset( $result['refund_recv_accout_0'] ) ? $result['refund_recv_accout_0'] : '原路退款';//退款入账方
        ...
        $status_str = '';
        $status_str = '
            <li class="active '.$waiting_str.'"><em></em><p>酒店审核中</p></li>
            <li '.$pending_str.'><em></em><hr><p>同意退款</p></li>
            ';
        $status_str .= '
            <li '.$processing.'><em></em><hr><p>'.$refund_name.'退款中</p></li>
            <li '.$success.'><em></em><hr><p>退款成功</p></li>
        ';
        ...
        $data['time'] = '预计1-3个工作日到账';//'预计'.$time.'前';

...
class Wechatmembercard extends MY_Admin_Api {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('member/Wechat_membercard_model',"wechatMembercard");
            ...
            foreach($data['custom_field_check'] as $check_value){
                ...
                switch($check_value){
                    case "supply_bonus":
                        ...
                        $data['balance_url'] = (isset( $data['balance_url']) && !empty($data['balance_url']) ) ? $data['balance_url'] : $inter_public['domain']."/index.php/member/crecord/balances?id=".$inter_id;
                        $count ++ ;
                        break;
                    case "supply_balance":
                        $data['supply_balance'] = true;
                        $data['bonus_url'] = (isset( $data['bonus_url']) && !empty($data['bonus_url']) ) ? $data['bonus_url'] : $inter_public['domain']."/index.php/member/crecord/bonus?id=".$inter_id;
                        $count ++ ;
                        break;
                    default:
                        $temp[] = $check_value;

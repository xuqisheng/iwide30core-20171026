...
class Qrcodelist extends MY_Admin_Roomservice {
	...
	public function index(){
        ...
        $base_url = site_url('eat-in/qrcodelist/index/');
        //获取公众号下的酒店
...
//导入权限
        ...
        //查询interId下的店铺
        $this->load->model('roomservice/roomservice_shop_model');
        $shop_info = $this->roomservice_shop_model->get_list(array('inter_id'=>$this->inter_id,'hotel_id'=>$entity_id,'is_delete'=>0,'sale_type'=>2));
        $shop_list = array();
        if($shop_info){

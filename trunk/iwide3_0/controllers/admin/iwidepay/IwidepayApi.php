...
class IwidepayApi extends MY_Controller
{
    ...
    public function get_order_search()
    {
        ...
        //模块
        $temp = array('0'=>'所有模块','hotel'=>'订房','soma'=>'商城','vip'=>'会员','okpay'=>'快乐付','dc'=>'在线点餐');
    ...
    public function get_module()
    {
        ...
        //模块
        $temp = array('all'=>'所有模块','hotel'=>'订房','soma'=>'商城','vip'=>'会员','okpay'=>'快乐付','dc'=>'在线点餐');
        foreach ($temp as $key => $value)
        {
            $item = array(
                'value' => "$key",
    ...
    public function hotel_rule()
    {
        ...
        if ($total > 0)
        {
            ...
            $module = array('hotel'=>'订房','soma'=>'商城','vip'=>'会员','okpay'=>'快乐付','dc'=>'在线点餐');
            $select = 'mi.rule_id,mi.inter_id,mi.hotel_id,mi.module,mi.rule_name,mi.edit_time,mi.status';
        ...
        if (!empty($hotels))
        {
            foreach ($hotels as $key => $value)
            {
                ...
                $item = array(
                    'hotel_id' => $value['hotel_id'],
                    'hotel_name' => $value['name'],
                    'status' => $r_number >= 5 || $m_module < 5 ? '0' : '1',
                );
    ...
    public function save_rule()
    {
        ...
        else
        {
            ...
            foreach ($rule_info as $item)
            {
                ...
                if ($data['module'] == 'all')
                {
                    $module = array('hotel','soma','vip','okpay','dc');

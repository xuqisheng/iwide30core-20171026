...
class Orders extends MY_Controller {
    ...
    public function to_private(){
        ...
        /*$data = array(
            ...
            'acctNo' => '6217857000054931488',
            'note'  => '分成',
        );*/
        $data = array(
            'version' => 'V2.0',
            'orderDate' => date('Ymd'),
            'orderNo' => 'bp150157072911',
            'requestNo' => 'yy150157072911',//time().rand(1000,9999),
            'transAmt' => 10,//单位：分
            ...
            //'bankType' =>'102',//行别
            //'addrName' => '郑州',//地区
             'accBankName' => '中国民生银行股份有限公司广州分行营业部',
            'acctNo' => '699790460',//6217857000054931488
            'note'  => '分成',

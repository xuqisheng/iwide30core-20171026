...
class Config_member_package extends MY_Admin_Soma {

	protected $label_controller= '配置会员礼包';		//在文件定义
	protected $label_action= '';

	protected function main_model_name()
	{
		return 'soma/Config_member_package_model';
	}
	...
	public function edit_post() {
		...
		if(isset($post[$pk])) { $model->load($post[$pk]); }

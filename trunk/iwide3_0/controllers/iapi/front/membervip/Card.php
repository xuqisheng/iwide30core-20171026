...
{   private $initTime;
    ...
    public function receive(){
        ...
        $card_result = CardService::getInstance()->receive($this->inter_id,$this->openid,$ec_code,$this->url_group);
	...
	public function cardinfo(){
        ...
        $card_result = CardService::getInstance()->cardinfo($this->inter_id,$this->openid,$member_card_id,$this->url_group);

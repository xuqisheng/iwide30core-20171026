...
//            redirect ( site_url ( '/distribute/dis_ext/perror' ) . '?id=' . $this->input->get ( 'id' ) );
    ...
    public function cardinfo(){
        ...
        if(!$this->is_restful()){
            ...
            $data = CardcenterService::getInstance()->cardinfo($this->show_inter_id,$this->show_openid,$this->inter_id,$member_card_id,$this->url_group,$extra);
        }
...
//	    $this->check_user_login();
    ...
    public function receive(){
        ...
        if(!$this->is_restful()){
            ...
            $data = CardcenterService::getInstance()->receive($this->show_inter_id,$this->show_openid,$ec_code,$this->url_group,$extra);
    ...
    public function receive_card(){
        ...
        if(!$this->is_restful()){
            ...
            $data = CardcenterService::getInstance()->receive_card($this->show_inter_id,$this->show_openid,$ec_code);
        }
        echo json_encode($data);
    }

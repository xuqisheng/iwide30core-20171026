...
class Card extends MY_Front_Member
{
    ...
    public function __construct()
    {
        ...
        $this->url_group['pcard_url']        = base_url("index.php/membervip/card/pcard?id={$this->inter_id}");
    ...
    public function index()
    {
        ...
        if (!$this->is_restful()) {
            ...
            if ($this->inter_id == 'a457946152') {
                $pms_coupon = CardService::getInstance()->pcard($this->inter_id, $this->openid, $this->url_group);
                $data       = array($pms_coupon, $data);
            }
        } else {

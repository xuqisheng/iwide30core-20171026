...
<a href="<?php echo $fa['ad_link'];?>" class="pad3 bg_fff bd h24 martop color_link" style="display:block"><em class="iconfont"><?php if(!strstr($fa['ad_img'],"http")) echo $fa['ad_img'];?></em><?php echo $fa['des'];?></a>
<?php }}?>
...
<div class="vote_spread bg_fff">
	...
	<a href="<?php echo $fa['ad_link'];?>">
        ...
        <div class="h28 txtclip">标题标题标题标题标题标题标题</div>
        <div class="h22 txtclip">说明说明说明说明说明说明说明</div>
    </a>
	<?php }}?>
</div>  
<script>
...
function day_rooms($startdate,$enddate,$price_code){
	pageloading('',0.4);
	$.post('/index.php/hotel/hotel/return_more_room?id=<?php echo $inter_id;?>&type=<?php echo $type?>',{
		h:'<?php echo $hotel['hotel_id']?>',
		start:$startdate,
		end:$enddate,

                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('eat-in/qrcodelist/add')?>" class="btn btn-sm bg-green" id="grid-btn-search">新增</a>&nbsp;&nbsp;</div>
                                </div>
                                </form>
                            </div>
                        </div>
...
<!--                                <td><a class="btn btn-default bg-green" href="<?php /*//echo site_url('eat-in/shop/edit?ids='.$v['shop_id'])*/?>">编辑</a></td>
-->                            </tr>
                            <?php }}?>
                        </table>
...
//'http://iwide.cn/',
    ...
    $(document).ready(function() {
        ...
        $('#output_all').click(function(){
            location.href="<?php echo site_url('eat-in/qrcodelist/output_qrcode')?>"+"?s=&all=1";
        });
        ...
        $('#file').uploadify({
            ...
            'uploader' : '<?php echo site_url('eat-in/qrcodelist/batch_import')?>',

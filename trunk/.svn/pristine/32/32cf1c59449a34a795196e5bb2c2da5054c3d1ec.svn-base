...
$buttions.= '<button type="button" class="btn btn-default disabled" id="grid-btn-edit"><i class="fa fa-edit"></i>&nbsp;处理</button>';
...
/*
$buttions.= '<div class="radio"><label><input type="radio" name="order_status" class="" value="0" checked>全部</label></div>';
$buttions.= '<div class="radio"><label><input type="radio" name="order_status" class="" value="1" >待审核</label></div>';
$buttions.= '<div class="radio"><label><input type="radio" name="order_status" class="" value="2" >待入住</label></div>';
$buttions.= '<div class="radio"><label><input type="radio" name="order_status" class="" value="3" >待离店</label></div>';*/
?>

...
<!--        <form action="<?php /*echo site_url('take-away/goods/add')*/?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal">
-->
        <?php if(isset($ids)){?>
        <?php echo form_open( site_url('take-away/goods/edit?ids='.$ids), array('class'=>'form-horizontal','enctype'=>'multipart/form-data' ), array() ); ?>
        <?php }else{?>
        <?php echo form_open( site_url('take-away/goods/add'), array('class'=>'form-horizontal','enctype'=>'multipart/form-data' ), array() ); ?>
<?php }?>
...
--><script>
    ...
    $(function() {
        ...
        $('#shop_id').change(function(){
            ...
            var url = '<?php echo site_url('take-away/goods_group/ajax_get_group_info')?>';
            $.post(url,{
                'shop_id':value,

...
(function(win) {
	var root = win.GV.DIMAUB+win.GV.JS_ROOT || location.origin + '/public/js/', //在wind.js加载之前定义GV.JS_ROOT
		...
		alias = {
            ...
            datetimepicker     : 'datetimepicker/jquery.datetimepicker.min',
            jquery             : 'jquery',
            ...
            draggable         : 'draggable',
            validate          : 'validate',
            artDialog         : 'art_Dialog/artDialog',
            art_dialog        : 'artDialog/dist/dialog-min',
            iframeTools       : 'art_Dialog/iframeTools',
            xd                : 'xd',//Iframe跨域通信
            ...
            zepto             : 'mdialog/zepto.min'
		},
        //CSS路径
		alias_css = {
            colorPicker : 'colorPicker/style',
            artDialog   : 'art_Dialog/skins/default',

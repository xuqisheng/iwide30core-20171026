    ...
    <div class="tabbable "> <!-- Only required for left/right tabs -->
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab2" data-toggle="tab"><i
									class="fa fa-list-alt"></i>子商户信息(订房配置) </a></li>
									<li><a href="#tab3" data-toggle="tab"><i
									class="fa fa-list-alt"></i>子商户信息（快乐付配置） </a></li>
					</ul>
						...
						<div class="tab-pane" id="tab2">
							...
							<div class="box-body">
								<div class="form-group  has-feedback">
									<label class="col-sm-2 control-label">子商户号(<?php echo $v['name']; ?>)</label>
									<div class="col-sm-8">
										<input type="text" class="form-control " name="sub_ok_mch_id_h_<?php echo $v['hotel_id']; ?>"
											id="sub_ok_mch_id_h_<?php echo $v['hotel_id']; ?>" placeholder="<?php echo (!empty($list['sub_ok_mch_id_h_'.$v['hotel_id']]))? $list['sub_ok_mch_id_h_'.$v['hotel_id']]: '商户号'; ?>"
											value="" >
									</div>
								</div>
							</div>
							<div class="box-body">
								<div class="form-group  has-feedback">
									<label class="col-sm-2 control-label">子支付密钥</label>
									<div class="col-sm-8">
										<input type="text" class="form-control " name="sub_ok_key_h_<?php echo $v['hotel_id']; ?>"
											id="sub_ok_key_h_<?php echo $v['hotel_id']; ?>" placeholder="<?php echo (!empty($list['sub_ok_key_h_'.$v['hotel_id']]))? $list['sub_ok_key_h_'.$v['hotel_id']]: '支付密钥'; ?>"
											value="" >
									</div>
								</div>
							</div>

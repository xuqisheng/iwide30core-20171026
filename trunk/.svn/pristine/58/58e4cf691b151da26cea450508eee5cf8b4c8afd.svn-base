...
<link href="<?php echo base_url('public/mall/multi/style/footer.css')?>" rel="stylesheet">
<link href="<?php echo base_url('public/mall/multi/style/feeling.css')?>" rel="stylesheet">
<link href="<?php echo base_url('public/mall/multi/style/shaking.css')?>" rel="stylesheet">
<title>点击礼盒领取礼物</title>
</head>
<body> 
<!-- 蒙版 -->
<div class="pull pullgift" style="text-align:center; background:rgba(53,57,60,0.9)">
    <img style="width:55%; padding-top:23%;" src="<?php echo base_url('public/mall/multi/images/txt1.png')?>" onclick="save_receive()"/>
</div>
<div style="min-height:90%">
    ...
    <div class="giftbox">
        <div class="boximg">
            <div class="lid"><img src="<?php echo base_url('public/mall/multi/images/gift02.png')?>"></div>
            <div class="relative">
                <img src="<?php echo base_url('public/mall/multi/images/gift01.png')?>">
                <img style="position:absolute;width:18%;right:13%; bottom:13%; opacity:0.5"src="<?php $hotel['intro_img']?>" rc="<?php echo base_url('public/mall/multi/images/logo2.png')?>">
            </div>
        </div>
    </div>
</div>
<a class="again" style="position:static; padding:4% 0;" href=""><span>关注公众号 <img src="<?php echo base_url('public/mall/multi/images/ico/goIco.png')?>" /></span></a>
</body>
<script>
$(window).load(function(){
	...
	$('.boximg').click(function(){
		...
		window.setTimeout(function(){
			_this.find('.lid img').attr('src',"<?php echo base_url('public/mall/multi/images/gift03.png')?>");
			//动作结束 

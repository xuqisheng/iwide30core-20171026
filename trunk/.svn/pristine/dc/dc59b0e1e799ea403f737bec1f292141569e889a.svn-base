...
<div head class="bg_fff pad3 topfixed" style="border-bottom:7px solid #eee">
    <em class="ico iconfont bg_main">&#xe602;</em><?php if(isset($time)){echo $time;}elseif($type=='D'){echo '今天';}elseif($type=='W'){echo '本周';}elseif($type=='M'){echo '本月';}elseif($type=='A'){echo '总间夜';}else{echo "";}?>
</div>
...
<div foot class=" center bottomfixed">
    <div class="webkitbox">
        <a href="?type=D" class="pad3 bg_555">今天<tt class="color_main">(<?php echo $count['day'];?>)</tt></a>
        <a href="?type=W" class="pad3 bg_555 bd_lr">本周<tt class="color_main">(<?php echo $count['week'];?>)</tt></a>
        <a href="?type=M" class="pad3 bg_555">本月<tt class="color_main">(<?php echo $count['month'];?>)</tt></a>
        <a href="?type=A" class="pad3 bg_555 bd_left">总间夜<tt class="color_main">(<?php echo $count['all'];?>)</tt></a>
    </div>
</div>

...
<head>
    ...
    <title><?php if(isset($page_title)) echo $page_title; else echo $this->_ci_cached_vars['filed_name']['credit_name'].'记录';?></title>
            ...
            <div class="weui_tab">
                <div class="weui_navbar">
                    ...
                    <div class="weui_navbar_item <?php if($credit_type==1){ ?> weui_bar_item_on <?php } ?> ">
                        <a href="<?php echo base_url("index.php/membervip/bonus?credit_type=1")?>">增加<?php echo $this->_ci_cached_vars['filed_name']['credit_name']; ?></a>
                    </div>
                    <div class="weui_navbar_item <?php if($credit_type==2){ ?> weui_bar_item_on <?php } ?> ">
                        <a href="<?php echo base_url("index.php/membervip/bonus?credit_type=2")?>">消费<?php echo $this->_ci_cached_vars['filed_name']['credit_name']; ?></a>
                    </div>
                </div>

...
<div class="page">
    ...
    <?php if (!$can_buy){?>
        ...
        <script >
        $.MsgBox.Confirm('请先注册成为洲际会员',function(){window.location.href="<?php echo base_url('index.php/membervip/verify');?>"},function(){window.location.href="<?php echo base_url('index.php/membervip/center');?>"},'马上注册','取消')
        </script>
        <?php 
    }
        ?>

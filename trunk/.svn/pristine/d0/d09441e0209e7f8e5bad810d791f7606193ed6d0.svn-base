...
window.onload=function(){
	setTimeout(function(){window.location.href="<?php echo site_url('mall/wap/comment/show/'.$comment_id)?>?id=<?php echo $inter_id?>&t=<?php echo $topic['identity'] ?>&cid=<?php echo $comment_id?>&saler=<?php echo $saler?>&f=<?php echo $fans_id?>";},1500)
}
</script>
</html>

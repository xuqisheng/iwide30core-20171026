...
<div class="list_style_3">
    <?php if($left!=0){ ?>
	<a class="bdradius" href="<?php echo site_url('club/club/add_club?id=').$inter_id;?>">
    ...
    <?php }?>
	<a class="bdradius" href="<?php echo site_url('club/club/club_list?id=').$inter_id;?>">
    	<div><em class="iconfont" style="background:#00a0e9">&#xE609;</em>社群客列表</div>
        <tt><?php echo $amount?$amount:'0';?>个</tt>
    </a>
	<a class="bdradius" href="<?php echo site_url('club/club/income_list?id=').$inter_id;?>">
    	<div><em class="iconfont" style="background:#ea68a2">&#xE60d;</em>收益记录</div>
    </a>
    <?php if($inter_id !='a487173166' || $inter_id !='a472731996'){ ?>
        <a class="bdradius" href="<?php echo site_url('club/club/ranking?id=').$inter_id;?>">
            <div><em class="iconfont" style="background:#fe9402">&#xE607;</em>社群客琅琊榜</div>
        </a>
    <?php }?>
	<a class="bdradius" href="<?php echo site_url('club/club/qa_help?id=').$inter_id;?>">

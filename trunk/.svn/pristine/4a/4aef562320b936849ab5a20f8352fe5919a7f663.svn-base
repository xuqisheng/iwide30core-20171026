    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form id="myForm" action="<?php echo base_url('index.php/membervip/wxmember/saveconfig'); ?>" method="post">
                <input type="hidden" name="wx_card_id" value="<?php if (isset($wx_card_id))echo $wx_card_id;?>">
...
<?php if (isset($send_check)) {if ($send_check == 1){echo '通过';}elseif ($send_check == 2) {echo '不通过';}elseif ($send_check == 3){echo '审核中';}}else {echo '请完善资料';}?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($brand_name)) echo 'disabled';?> type="text" name="brand_name" value="<?php if (isset($brand_name))echo $brand_name;?>">
                                            &nbsp;&nbsp;
                        ...
                        <table class="table table-bordered table-striped table-condensed dataTable no-footer">
                                    ...
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input <?php if ((isset($custom_field1) && $custom_field1 != '') || (isset($bonus_order) && $bonus_order == 1) || (isset($balance_order) && $balance_order == 1)) {echo 'checked';} ?>
                                                type="radio" name="custom_field1_is_set" class="custom_field1_is_set" value="1"
                                                <?php if ((isset($bonus_order) && $bonus_order == 1) || (isset($balance_order) && $balance_order == 1)) {echo 'disabled';}?>
                                            ><label>显示</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input type="radio" name="custom_field1_is_set" <?php if (isset($custom_field1) && $custom_field1 == '' && (isset($bonus_order) && $bonus_order != 1) && (isset($balance_order) && $balance_order != 1)) {echo 'checked';} ?> class="custom_field1_is_set" value="2"
                                                <?php if ((isset($bonus_order) && $bonus_order == 1) || (isset($balance_order) && $balance_order == 1)) {echo 'disabled';}?>><label>不显示</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <select name="custom_field1_name_type" id="custom_field1_name_type" class="custom_field1" <?php if ((isset($bonus_order) && $bonus_order == 1) || (isset($balance_order) && $balance_order == 1)) {echo 'disabled';}?> >
                                        ...
                                        <div class="controls1 m_r_75">
                                            显示名称：
                                            <input class="custom_field1" <?php if (!isset($custom_field1['name'])) {echo 'disabled';}?> type="text" name="custom_field1_name" id="custom_field1_name" value="<?php if (isset($custom_field2['name'])) {echo $custom_field2['name'];}?>">
                                        </div>
                                        <div class="controls1 m_r_75">
                                            跳转URL
                                            <input class="custom_field1" <?php if (!isset($custom_field1['name'])) {echo 'disabled';}?> type="text" name="custom_field1_url" id="custom_field1_url" value="<?php if (isset($custom_field2['name'])) {echo $custom_field2['url'];}?>" >
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input <?php if ((isset($custom_field2) && $custom_field2 != '') || (isset($bonus_order) && $bonus_order == 2) || (isset($balance_order) && $balance_order == 2)) {echo 'checked';} ?>
                                                type="radio" name="custom_field2_is_set" class="custom_field2_is_set" value="1"
                                                <?php if ((isset($bonus_order) && $bonus_order == 2) || (isset($balance_order) && $balance_order == 2)) {echo 'disabled';}?>><label>显示</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($custom_field2) && $custom_field2 == '' && (isset($bonus_order) && $bonus_order != 2) && (isset($balance_order) && $balance_order != 2)) {echo 'checked';} ?>
                                                type="radio" name="custom_field2_is_set" class="custom_field2_is_set" value="2"
                                                <?php if ((isset($bonus_order) && $bonus_order == 2) || (isset($balance_order) && $balance_order == 2)) {echo 'disabled';}?> ><label>不显示</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <select class="custom_field2" name="custom_field2_name_type" id="custom_field2_name_type" <?php if ((isset($bonus_order) && $bonus_order == 2) || (isset($balance_order) && $balance_order == 2)) {echo 'disabled';}?> >
                                        ...
                                        <div class="controls1 m_r_75">
                                            显示名称：
                                            <input class="custom_field2" <?php if (!isset($custom_field2['name'])) {echo 'disabled';}?> type="text" name="custom_field2_name" id="custom_field2_name" value="<?php if (isset($custom_field2['name'])) {echo $custom_field2['name'];}?>">
                                        </div>
                                        <div class="controls1 m_r_75">
                                            跳转URL
                                            <input class="custom_field2" <?php if (!isset($custom_field2['name'])) {echo 'disabled';}?> type="text" name="custom_field2_url" id="custom_field2_url" value="<?php if (isset($custom_field2['name'])) {echo $custom_field2['url'];}?>">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($custom_field3) && $custom_field3 != '') {echo 'checked';} ?> type="radio" name="custom_field3_is_set" class="custom_field3_is_set" value="1"><label>显示</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($custom_field3) && $custom_field3 == '') {echo 'checked';} ?> type="radio" name="custom_field3_is_set" class="custom_field3_is_set" value="2"><label>不显示</label>

                                        </div>
                                        <div class="controls1 m_r_75">
                                            <select class="custom_field3" name="custom_field3_name_type" id="custom_field3_name_type">
                                        ...
                                        <div class="controls1 m_r_75">
                                            显示名称：
                                            <input class="custom_field3" <?php if (!isset($custom_field3['name'])) {echo 'disabled';}?> type="text" name="custom_field3_name" id="custom_field3_name" value="<?php if (isset($custom_field3['name'])) {echo $custom_field3['name'];}?>" >
                                        </div>
                                        <div class="controls1 m_r_75">
                                            跳转URL
                                            <input class="custom_field3" <?php if (!isset($custom_field3['name'])) {echo 'disabled';}?> type="text" name="custom_field3_url" id="custom_field3_url" value="<?php if (isset($custom_field3['name'])) {echo $custom_field3['url'];}?>">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table class="table table-bordered table-striped table-condensed dataTable no-footer">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($center_title) && $center_title != '') {echo 'checked';} ?> type="radio" name="center_is_set" value="1" class="center_btn_is_set"><label>设置</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input <?php if (isset($center_title) && $center_title == '') {echo 'checked';} ?> type="radio" name="center_is_set"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input type="text" name="center_title" value="<?php if (isset($center_title) && $center_title != '') {echo $center_title;} ?>" class="center_btn">&nbsp;&nbsp;<label>使用按钮名称，字数上限为6个汉字</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input type="text" name="center_url"
                                                   value="<?php if (isset($center_url) && $center_url != '') {echo $center_url;} ?>" class="center_btn">&nbsp;&nbsp;<label>跳转的页面网址</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input type="text" name="center_sub_title"
                                                   value="<?php if (isset($center_sub_title) && $center_sub_title != '') {echo $center_sub_title;} ?>" class="center_btn">&nbsp;&nbsp;<label>使用按钮名称，字数上限为20个汉字</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table class="table table-bordered table-striped table-condensed dataTable no-footer">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input type="radio" name="custom_cell1_is_set" <?php if (isset($custom_cell1) && $custom_cell1 != '') {echo 'checked';} ?>
                                                
                                                   value="1" class="custom_cell1_is_set">&nbsp;&nbsp;<label>设置</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input type="radio" name="custom_cell1_is_set" <?php if (isset($custom_cell1) && $custom_cell1 == '') {echo 'checked';} ?>
                                                   value="2" class="custom_cell1_is_set">&nbsp;&nbsp;<label>不设置</label>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            名称
                                            <input type="text" name="custom_cell1_name"
                                                   value="<?php if (isset($custom_cell1['name'])) {echo $custom_cell1['name'];} ?>" class="custom_cell1">&nbsp;&nbsp;<label>使用按钮名称，字数上限为5个汉字</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            引导语
                                            <input type="text" name="custom_cell1_tips"
                                                   value="<?php if (isset($custom_cell1['tips'])) {echo $custom_cell1['tips'];} ?>" class="custom_cell1">&nbsp;&nbsp;<label>使用按钮名称，字数上限为6个汉字</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            链接地址
                                            <input type="text" name="custom_cell1_url"
                                                   value="<?php if (isset($custom_cell1['url'])) {echo $custom_cell1['url'];} ?>" class="custom_cell1">&nbsp;&nbsp;<label>使用按钮名称，字数上限为6个汉字</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            <input type="radio" name="custom_cell2_is_set" <?php if (isset($custom_cell2) && $custom_cell2 != '') {echo 'checked';} ?>
                                                   value="1" class="custom_cell2_is_set">&nbsp;&nbsp;<label>设置</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            <input type="radio" name="custom_cell2_is_set" <?php if (isset($custom_cell2) && $custom_cell2 == '') {echo 'checked';} ?>
                                                   value="2" class="custom_cell2_is_set">&nbsp;&nbsp;<label>不设置</label>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-group p_3">
                                        <div class="controls1 m_r_75">
                                            名称
                                            <input type="text" name="custom_cell2_name"
                                                   value="<?php if (isset($custom_cell2['name'])) {echo $custom_cell2['name'];} ?>" class="custom_cell2">&nbsp;&nbsp;<label>使用按钮名称，字数上限为5个汉字</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            引导语
                                            <input type="text" name="custom_cell2_tips"
                                                   value="<?php if (isset($custom_cell2['tips'])) {echo $custom_cell2['tips'];} ?>" class="custom_cell2">&nbsp;<label>使用按钮名称，字数上限为6个汉字</label>
                                        </div>
                                        <div class="controls1 m_r_75">
                                            链接地址
                                            <input type="text" name="custom_cell2_url"
                                                   value="<?php if (isset($custom_cell2['url'])) {echo $custom_cell2['url'];} ?>" class="custom_cell2">&nbsp;&nbsp;<label>使用按钮名称，字数上限为6个汉字</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>

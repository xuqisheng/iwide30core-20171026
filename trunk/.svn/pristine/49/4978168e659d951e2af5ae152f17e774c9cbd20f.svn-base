...
<?php if(isset($id)){?>
<?php echo form_open('take-away/printer/edit?ids='.$id,array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }else{?>
<?php echo form_open('take-away/printer/add',array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }?>
...
<script>
    function change_source(){
        ...
        location.href = '<?php echo site_url('take-away/printer/add?s=')?>' + s;
    }

  ...
  <div class="row">
	<div class="col-xs-12">
	  ...
	  <input type="text" name="o_id" value="<?php echo $condition['o_id'];?>">-->
                ...
                <p><div style="float: left;width:80px;text-align: center">支付方式</div>
                      <select name="pay_type">
                        <option value="">所有</option>
                        <?php
                            foreach($condition['o_pay_way'] as $k=>$v){
	  ...
	  <input type="submit" name="Submit" value="提交">   <input type="button" onClick="$('#qfexport').submit()" value="批量导出">
			...
			<thead>
			  <tr role="row">
				...
				<th width="10%" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="">订单号</th>
                  <th width="10%" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="">PMS订单号</th>
				...
				<th width="5%" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="">房型</th>

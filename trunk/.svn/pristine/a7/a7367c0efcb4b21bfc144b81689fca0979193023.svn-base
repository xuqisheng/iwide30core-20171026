...
class Soma_Logger
{
    ...
    {
        $logDirectory = isset($params['logDirectory']) ? $params['logDirectory'] : APPPATH . 'logs/soma';
        $logLevelThreshold = isset($params['logLevelThreshold']) ? $params['logLevelThreshold'] : LogLevel::DEBUG;

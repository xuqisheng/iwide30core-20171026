...
<!-- form start -->
        <div class="tab-content">
			...
			<?php echo form_open( site_url('hotel/orders_ticket/edit_post'), array('id'=>'code_form','class'=>'form-horizontal','enctype'=>'multipart/form-data' ), array('orderid'=>$list['orderid'],'hotel_id'=>$list['hotel_id']) ); ?>
                <div class="box-body">
		    ...
		    <!-- <div class="form-group  has-feedback">
                    ...
                    <div class="form-group  has-feedback">
						...
						<div class="col-sm-8">
							...
							<a style='text-decoration: underline;' href='javascript:void(0);' onclick='$("#holdtime").val("<?php echo date('Y-m-d 18:00',strtotime($list['startdate']));?>");'>使用日期18点</a>
                    ...
                    <!-- <div class="form-group  has-feedback">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control " name="mt_pms_orderid" id="remark" placeholder="PMS订单号" value="<?php echo $list['mt_pms_orderid']?>">
                        </div>
                    </div> -->
					</div>
					</div>

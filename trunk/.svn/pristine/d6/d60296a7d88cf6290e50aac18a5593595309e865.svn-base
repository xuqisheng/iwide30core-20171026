...
//$buttions.= '<button type="button" class="btn btn-sm bg-green" id="grid-btn-add"><i class="fa fa-plus"></i>&nbsp;新增员工</button>';
...
//$buttions.= '<button type="button" class="btn btn-sm disabled" style="margin-left:10px" id="grid-btn-del"><i class="fa fa-trash"></i>&nbsp;一键删除</button>';
//$buttions.= '<button type="button" class="btn btn-sm disabled" style="margin-left:10px" id="grid-btn-pass"><i class="fa fa-trash"></i>&nbsp;一键通过</button>';
...
var url_edit= '<?php
                        if($this->input->get('ids')){
                            echo EA_const_url::inst()->get_url("*/*/edit").'?ads='.$this->input->get('ids');
                        }else{
                            echo EA_const_url::inst()->get_url("*/*/edit");
                        }
?>';			//跟button对应			//跟button对应
var url_pass= '<?php echo EA_const_url::inst()->get_url("*/*/edit"); ?>';		//跟button对应
...
if( count($result['data'])<$num){
    ...
    $gridjs= VIEWPATH. $tpl .DS . $m. DS. 'customer_editjs.php';

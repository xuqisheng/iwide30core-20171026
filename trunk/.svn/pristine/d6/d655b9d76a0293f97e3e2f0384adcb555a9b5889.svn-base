...
//         $cert->certId = $certId;
    ...
    public static function getSignKeyFromPfx($certPath='', $certPwd='000000')
    {
    	$certPath=UnionPayConfig::getSignCertPath();
		$certPwd=UnionPayConfig::getSignCertPwd();
    ...
    public static function getSignCertIdFromPfx($certPath='', $certPwd='000000')
    {
    	$certPath=UnionPayConfig::getSignCertPath();
    	$certPwd=UnionPayConfig::getSignCertPwd();
        if (!array_key_exists($certPath, CertUtil::$signCerts)) {
...
// 	    $cert->certId = $certId;
    ...
    private static function initVerifyCerts($cert_dir='') {
    	$cert_dir = UnionPayConfig::getVerifyCertDir();

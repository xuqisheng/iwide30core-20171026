...
class Package extends MY_Front_Soma
{
    ...
    public function package_detail()
    {
        ...
        if (is_null($isOff) || $isOff === true) {
            ...
            if($ticketId){
                ...
                if(!empty($ticket)){
                    ...
                    $theme = $this->ThemeConfigModel->get_theme_detail([$ticket[0]['theme_id']], $this->inter_id);
                    if(!empty($theme)){
                        $this->theme = $theme[0]['theme_path'];
                    }
                }
            }
            ...
            if((in_array($this->theme, $themeArr) || $ticketId) && $this->theme != 'mooncake4') {
                $this->theme = 'v1';
            }
        ...
        if ($productId) {
            ...
            // var_dump($ps_info, $ps_detail);exit;
            // 加载多规格信息完毕
        }
...
//        $postArr = array(10016=>3400);
    ...
    public function package_pay()
    {
        ...
        $header = array(
            'title' => $this->lang->line('purchase_payment')
        );

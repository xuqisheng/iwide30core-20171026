		 ...
		 <section class="content">
          <div class="row">
            <div class="col-xs-12">
             ...
             <td><?php echo $lt[$k];?></td>
             <?php endforeach; ?>
             <td><a href='<?php echo site_url('hotel/gallery/type_edit').'?tid='.$lt['id'];?>'>修改</a></td>
             </tr>
                    <?php }}?>
                  </table>
		</div><!-- /.box-body -->
				...
				<div class="col-xs-3">
                  	<a href="<?php echo site_url('hotel/gallery/type_edit'); ?>" class="btn btn-default" >增加</a>
                </div>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
<?php 

...
<page class="page">
    ...
    <footer>
        <a class="bg_main center pad12" style="display:block" href="<?php echo site_url('roomservice/roomservice/address?id='.$inter_id.'&hotel_id='.$hotel_id.'&shop_id='.$shop_id)?>" ><em class="iconfont">&#XAD;</em> 新建联系信息</a>
    </footer>
</page>
</body>
</html>

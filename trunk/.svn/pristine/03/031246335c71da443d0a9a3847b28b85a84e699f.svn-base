                                ...
                                <div  class="weui_media_box weui_media_appmsg">
                                	<div class="box clearfix">
                                        <?php if(!isset($card['is_pms_card'])){ ?>
                                            <a href="<?=!empty($cardinfo_url)?"{$cardinfo_url}&member_card_id={$card['member_card_id']}":''?>">
                                        <?php }else{ ?>
                                            <a href="<?=!empty($pcardinfo_url)?"{$pcardinfo_url}&member_card_id={$card['member_card_id']}":''?>">
                                        <?php } ?>
    									...
    									<div class="f_date" >
                                            <?php if(!isset($card['is_pms_card'])){ ?>
                                                <?php if(!empty($card['is_can_give_friend']) && $card['is_can_give_friend'] == 't' && $auth_gift === true){ ?>
                                                    <a href="<?=!empty($givecard_url)?"{$givecard_url}&member_card_id={$card['member_card_id']}":''?>" class="weui_btn weui_btn_mini weui_btn_primary" style="float:left;display: none;">赠送好友</a>
                                                <?php }?>

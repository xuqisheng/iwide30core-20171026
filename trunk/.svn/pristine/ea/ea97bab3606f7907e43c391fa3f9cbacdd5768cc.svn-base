          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <!-- 
                ...
                <div class="row">
                	<div class="col-sm-12">
                	<?php echo form_open('hotel/hotel_report/all_order_rn',array('class'=>'form-inline','id'=>'para_form'));?>
				    ...
				    <?php }?>
                        <div class="form-group" >
                            <label>公众号</label>
                            <input type='text' id='inter_id' name='inter_id' value='<?php if (!empty($posts['inter_id'])) echo $posts['inter_id'];?>' />
                        </div>
                	<div class="form-group" >
                		<label>入住人姓名</label>
                		<input type='text' id='in_name' name='in_name' value='<?php if (!empty($posts['in_name'])) echo $posts['in_name'];?>' />
                	</div>
                	<div class="form-group" >
                		<label>电话</label>
                		<input type='text' id='in_tel' name='in_tel' value='<?php if (!empty($posts['in_tel'])) echo $posts['in_tel'];?>' />
                	</div>
                	<div class="form-group" >
                		<label>微信订单号</label>
...
function out_port(){
	location.href='<?php echo site_url("hotel/hotel_report/ext_all_order_rn").'?'?>'+$('#para_form').serialize();
}

...
$buttions.= '<button type="button" class="btn btn-default" id="grid-btn-extra-0"><i class="fa fa-cube"></i>&nbsp;信息管理</button>';
$buttions.= '<button type="button" class="btn btn-default" id="grid-btn-extra-1"><i class="fa fa-wrench"></i>&nbsp;输入项</button>';
...
var url_extra= [
'../suform_showinfo/index','../forminput/index'
];

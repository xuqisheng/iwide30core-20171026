	  ...
	  <input type="submit" name="Submit" value="提交">
		  ...
		  <table id="data-grid" class="table table-bordered table-striped table-condensed dataTable" role="grid" aria-describedby="data-grid_info">
			<thead>
			  <tr role="row">
                  ...
                  <th width="10%" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="">优惠券总金额</th>
			...
			<tfoot>
			  <tr>
				...
				<th rowspan="1" colspan="1">优惠券总金额</th>
		  ...
		  <?php foreach($datalist as $dl){ ?>
			  <tr id="28" role="row" class="odd">
				...
				<td><?php echo $hotel_list[$dl['hotel_id']];?></td>
				<td><?php echo $dl['web_orderid'];?></td>

				<td><?php echo $dl['orderid'];?></td>
                <td><?php echo date('Y-m-d H:i',$dl['order_time']);?></td>
				<td><?php echo $dl['startdate'];?></td>
				<td><?php echo $dl['enddate'];?></td>

				<td><?php echo $dl['name'];?></td>
                <td><?php echo $dl['tel'];?></td>
                <td><?php echo $dl['roomnums'];?></td>
                  <td><?php
                      $coupon_favour = '';
                      ...
                      echo $coupon_favour;
                      ?></td>
                  <td><?php echo $dl['coupon_amount'];  ?></td>
				...
				<td><?php if($dl['paid']==0){
                  ...
                  <td><?php echo $condition['o_status'][$dl['status']];?></td>
                  ...
                  <td><?php echo ($dl['price']+$dl['coupon_favour']);?></td>

          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <!-- 
                ...
                <div class="row">
                	<div class="col-sm-12">
                	<?php echo form_open('hotel/hotel_report/order_htl',array('class'=>'form-inline','id'=>'para_form'));?>
...
function out_port(){
	location.href='<?php echo site_url("hotel/hotel_report/ext_order_htl").'?'?>'+$('#para_form').serialize();
}
...
// 	  modal.find('.modal-body input').val(recipient)
	...
	$.getJSON('<?php echo site_url("hotel/hotel_report/get_cofigs?ctyp=ORDERS_BY_HOTEL")?>',function(data){
...
$('#set_btn_save').click(function(){
	$.post('<?php echo site_url("hotel/hotel_report/save_cofigs?ctyp=ORDERS_BY_HOTEL")?>',$("#setting_form").serialize(),function(data){
		if(data == 'success'){

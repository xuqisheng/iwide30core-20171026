            ...
            <div class="col-xs-12">
              ...
              <!-- 
                ...
                <div class="row">
                	...
                	<div class="row">
                	<div class="col-sm-12">
<!--                  <?php echo form_open(site_url('distribute/distribute/batch_update'),array('enctype'=>'multipart/form-data'))?>-->
<!--                   	<label>批量更新业绩<input type="file" name="userfile" /></label> -->
<!--                   	<input type="submit" /> -->
<!--                   </form> -->&nbsp;</div></div>
                  <table id="data-grid" class="table table-bordered table-striped table-condensed">
                    <thead>
                        	...
                        	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="酒店: activate to sort column ascending">酒店</th>
                    		...
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="员工返佣: activate to sort column ascending">员工返佣</th>
                    ...
                    <tbody><?php foreach ($res as $item):?>
                        ...
                        <td><?=isset($item['saler']) ? $item['saler'] : '-'?></td>
                        <td><?=isset($item['send_time']) ? $item['send_time'] : '-'?></td>
                        <td><?=isset($item['grade_total']) ? $item['grade_total'] : '-'?></td>
                        <td><?=isset($hotels[$item['saler_hotel_id']]) ? $hotels[$item['saler_hotel_id']] : '-'?></td>
                        <td><?=$item['orderid']?></td>

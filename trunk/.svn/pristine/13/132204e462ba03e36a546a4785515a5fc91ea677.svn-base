...
$('#data-grid tbody').on('click', 'tr', function(){
	...
	if(selected.length==1){
        ...
        $('#grid-btn-edit-publics').removeClass('disabled').bind('click', selected, function(ev){
            window.location= url_edit_publics+ '?ids='+ ev.data;
        });
        ...
        $('#grid-btn-edit-publics').addClass('bg-green');
        ...
        $('#grid-btn-edit-publics').addClass('disabled').removeClass('bg-green').unbind();

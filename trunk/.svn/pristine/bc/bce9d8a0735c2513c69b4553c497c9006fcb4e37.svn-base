...
class Financeexp_model extends MY_Model { 

    public function get_resource_name() 
    { 
        return 'Financeexp_model'; 
    } 
    ...
    public function get_price_code_name($orderid) {
    	$result = $this->_db('iwide_r1')->query("SELECT * FROM iwide_hotel_order_items WHERE orderid='".$orderid."' limit 1")->result_array();
    	return $result;
    }
    
    public function order_additions($orderid) {
    	$result = $this->_db('iwide_r1')->query("SELECT * FROM iwide_hotel_order_additions WHERE orderid='".$orderid."' limit 1")->result_array();
    	return $result;
    }

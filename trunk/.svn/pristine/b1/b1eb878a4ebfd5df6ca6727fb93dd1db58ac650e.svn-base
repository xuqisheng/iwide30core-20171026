            ...
            <div class="content-wrapper" style="min-width:1130px; ">
                ...
                <div class="contents_list bg_fff" style="font-size:13px;margin-top:20px">
                    <div class="classifications display_flex">
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==1)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=1')?>">待付款</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==2)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=2')?>">待确认</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==3)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=3')?>">待配送</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==4)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=4')?>">配送中</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==5)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=5')?>">已完成</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==6)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index?order_status=6')?>">已取消</a></div>
                        <div <?php if(isset($filter['order_status'])&&$filter['order_status']==99)echo 'class="add_active"'?>><a href="<?php echo site_url('roomservice/orders/index')?>">所有状态</a></div>
                    </div>
                </div>
                <div style="padding: 10px;">
                    <form class="form" method='get' id="this_form" action='<?php echo site_url('roomservice/orders/index')?>'>
                    ...
                    <?php if(!empty($res)){ foreach($res as $k => $list){?>
                        <div class="border_1 m_t_10 bg_fff">
                            ...
                            <div>
                                ...
                                <span><?php echo $list['verify_name'] ?></span><br>
                                <span><?php echo $list['verify_phone'] ?></span><br>
    ...
    <script>
        ...
        $('.cancel_dd').click(function()
        {
            ...
            $.ajax({
                dataType:"json",
                type:'post',
                url:"<?php echo site_url('/roomservice/orders/dadaCancelOrder')?>",
                data:data,
        ...
        $('.resend_dd').click(function()
        {
            ...
            $.ajax({
                dataType:"json",
                type:'post',
                url:"<?php echo site_url('/roomservice/orders/reSendOrderToDada')?>",
                data:data,
                success: function(res)
                {
                    alert(res.msg);
        ...
        $('.send_dd').click(function()
        {
            ...
            $.ajax({
                dataType:"json",
                type:'post',
                url:"<?php echo site_url('/roomservice/orders/send_dd')?>",
                data:data,
                success: function(res)
                {
                    alert(res.msg);
        ...
        $('.confirms_remark').click(function()
        {
            ...
            $.ajax({
                dataType:"json",
                type:'post',
                url:"<?php echo site_url('/roomservice/orders/save_remark')?>",
                data:data,
                success: function(res)
                {
                    alert(res.msg);
        ...
        $('.confirms_order').click(function()
        {
            ...
            if(a)
            {
                ...
                $.ajax({
                    dataType:"json",
                    type:'post',
                    url:"<?php echo site_url('/roomservice/orders/refund_goods')?>",
                    data:data,
                    beforeSend: function()
                    {
    ...
    <script>
        ...
        function change_status(order_id,status){
            if(order_id){
                ...
                $.post('<?php echo site_url('roomservice/orders/update_order_status');?>',{
                    oid:order_id,
                    status:status,
        ...
        function print_order(order_id){
            if(order_id){
                ...
                $.post('<?php echo site_url('roomservice/orders/print_order');?>',{
                    oid:order_id,
                    '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
                },function(data){
                    if(data.errcode==0){

...
<div class="btn_list border">
	...
	<a href="<?php echo site_url('mall/wap/order_details/'.$orders['order_id'])?>?id=<?php echo $inter_id?>&t=<?php echo $topic['identity'] ?>&saler=<?php echo $saler?>&f=<?php echo $fans_id?>" class="item">立即使用<span>领取或送朋友</span></a>
</div>

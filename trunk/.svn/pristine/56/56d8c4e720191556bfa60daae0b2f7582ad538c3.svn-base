...
$config['mongo_db']['default']['username'] = 'dev';
$config['mongo_db']['default']['password'] = 'dev';
$config['mongo_db']['default']['database'] = 'dev';
...
$config['mongo_db']['test']['username'] = 'dev';
$config['mongo_db']['test']['password'] = 'dev';
$config['mongo_db']['test']['database'] = 'dev';
...
$config['mongo_db']['soma']['no_auth'] = TRUE;
$config['mongo_db']['soma']['hostname'] = '30.iwide.cn';
$config['mongo_db']['soma']['port'] = '27017';
$config['mongo_db']['soma']['username'] = 'soma';
$config['mongo_db']['soma']['password'] = 'soma';
$config['mongo_db']['soma']['database'] = 'soma_statis_test';
$config['mongo_db']['soma']['db_debug'] = TRUE;
$config['mongo_db']['soma']['return_as'] = 'array';
$config['mongo_db']['soma']['write_concerns'] = (int)1;
$config['mongo_db']['soma']['journal'] = TRUE;
$config['mongo_db']['soma']['read_preference'] = NULL;
$config['mongo_db']['soma']['read_preference_tags'] = NULL;

/** 此代码用于部分功能仅在生产环境中出现 **/
if( isset($_SERVER['CI_ENV']) && $_SERVER['CI_ENV']=='production' ){
    //生产环境关闭
    $config['mongo_db']['soma']['no_auth'] = TRUE; // 没有账号密码
	$config['mongo_db']['soma']['hostname'] = '10.117.191.226';
	$config['mongo_db']['soma']['port'] = '27017';
	$config['mongo_db']['soma']['username'] = 'soma';
	$config['mongo_db']['soma']['password'] = 'soma';
	$config['mongo_db']['soma']['database'] = 'soma_statis';
	$config['mongo_db']['soma']['db_debug'] = FALSE;

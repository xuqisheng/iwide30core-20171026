...
.room_list .img{width:80px; min-width:80px; max-width:80px}
.squareimg{ padding-bottom:62.5%; overflow:hidden}
/* end */
</style>
...
<header class="headers"> 
    <div class="headerslide">
    	...
    	<a class="slideson ui_img_auto_cut" <?php if(!empty($gallery_count)){?> href="<?php echo Hotel_base::inst()->get_url("HOTEL_PHOTO",array('h'=>$hotel['hotel_id']));?>"<?php }?>>
...
<div class="list_style bd_bottom h24">
	<div href='javascript:void(0)' onclick="tonavigate(<?php echo $hotel['latitude'];?>,<?php echo $hotel['longitude'];?>,'<?php echo $hotel['name'];?>','<?php echo $hotel['address'];?>')" class="webkitbox justify arrow">
    	<span class="txtclip"><?php echo $hotel['address'];?></span>

...
//        tr.each(function (tk,to) {
//            if(to.id!=id) $(to).removeClass('bg-gray');
//        });
//        if($(this).hasClass('bg-gray')){
//            selected.splice( index, 1 );$(this).removeClass('bg-gray');
//        }else{$(this).addClass('bg-gray');}
...
//
//            $('#grid-btn-export').prop('disabled',false).removeClass('disabled').addClass('bg-green');
...
//
//            $('#grid-btn-export').addClass('disabled').removeClass('bg-green').unbind();
...
//            $('button.single-btn').each(function(i,e){$(this).addClass('disabled').removeClass('bg-green');});
//            $('#grid-btn-export').prop('disabled',true).addClass('disabled').removeClass('bg-green').unbind();
//        }
//    });

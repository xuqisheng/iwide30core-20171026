...
//$buttions.= '<button type="button" class="btn btn-default disabled single-btn" id="grid-btn-extra-0"><i class="fa fa-qrcode"></i>&nbsp;二维码</button>';
...
var url_extra= [
//'<?php echo EA_const_url::inst()->get_url("*/*/qrcode_fronturl"); ?>',
];

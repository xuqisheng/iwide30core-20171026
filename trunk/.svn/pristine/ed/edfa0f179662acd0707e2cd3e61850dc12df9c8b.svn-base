...
<?php echo referurl('css','basic_2.css',1,$media_path) ?>
...
<!--
<div class="ui_pull yingju">
	<ul class="yingju_bg">
    	<li class="yingju_logo">&nbsp;</li>
    	<li class="_1">酒店预定</li>
        <li class="_2"><a href="http://testyinju.iwide.cn/index.php/soma/package/index?id=a457946152">度假套餐</a></li>
        <li class="_3"><a href="http://testyinju.iwide.cn/index.php/mall/wap/topic?id=a457946152&t=jpvdn3">雅活商城</a></li>
        <li class="_4"><a href="http://mp.weixin.qq.com/s?__biz=MjM5NTIxMTY2MA==&mid=400336665&idx=1&sn=5c3cd774f66ec77f5f909fe52a848d98&scene=4#wechat_redirect">隐居美图</a></li>
    </ul>
</div>
<script>
$('.yingju li._1').click(function(){
	$('.yingju').slideUp();
})
</script>
-->
...
<div class="often_like">
	...
	<div class="like">
    	<em class="iconfont ui_color">&#x2a;</em><span>我的收藏</span>
    </div>
</div>
<div class="ui_pull like_pull" id="collects" style="display:none;" onClick="toclose()">
    <div class="pull_box">
        ...
        <ul>
            ...
            <li><a href="<?php echo $hc['mark_link']?>" onclick="stop_bubble()"><?php echo $hc['mark_title'];?></a></li>
            <?php }?>
        </ul>
...
<div class="ui_pull often_pull" style="display:none;" onClick="toclose()">
    <div class="pull_box">
       ...
       <?php foreach($last_orders as $lo){?>
            <li><a href="<?php echo site_url('hotel/hotel/index').'?id='.$inter_id.'&h='.$lo['hotel_id']?>" onclick="stop_bubble()"><?php echo $lo['hname']; ?></a></li>
            <?php }?>
        </ul>
<!--         <a href="often_like.html" class="pull_more">查看更多</a> -->
        <?php } else {?>

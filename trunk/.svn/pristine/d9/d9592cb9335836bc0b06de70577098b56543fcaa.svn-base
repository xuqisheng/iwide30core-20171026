...
class Share_config_model extends MY_Model_Soma {
    ...
    {
        return $this->_shard_table('soma_cms_share_config', $inter_id);
    }
    public function table_name_r($inter_id=NULL)
    {
        return $this->_shard_table_r('soma_cms_share_config', $inter_id);
    }
	...
	public function attribute_labels()
	{
		return array(
            ...
            'position'=> '类型',
            'share_title'=> '分享标题',
            'share_title_en'=> 'Title',
            'share_link'=> '分享链接',
            'share_img'=> '分享图标',
            'share_desc'=> '分享描述',
            'share_desc_en'=> 'Description',
    ...
    public function get_share_config_list( $position=NULL, $inter_id=NULL )
    {
        ...
        // return $this->_shard_db( $inter_id )->where( $filter )->order_by( 'sort DESC' )->get( $table_name )->row_array();
        return $this->_shard_db_r('iwide_soma_r')->where( $filter )->order_by( 'sort DESC' )->get( $table_name )->row_array();
    }

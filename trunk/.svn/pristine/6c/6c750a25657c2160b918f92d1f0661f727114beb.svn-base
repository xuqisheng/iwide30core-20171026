    ...
    <?php if($hotel_id!=0){?>
        <div class="form-group col-xs-8">
            ...
            <div class="col-sm-8">
                ...
                <?php foreach($coexist_des as $code=>$des){?>
                	<option value='<?php echo $code;?>' <?php if($code==$list['coexist']){?> selected <?php }?>><?php echo $des;?></option>
				<?php }?>
                </select>
            </div>
        </div>
    ...
    <div id='ads'>
        ...
        <?php if(!empty($ads['ads']['hotel'])){ foreach ($ads['ads']['hotel'] as $aa){?>
            <div key='key' ad_id='<?php echo $aa['id'];?>' class="form-group col-xs-8">    
                <p><img src='<?php echo $aa['ad_img'];?>' /></p>

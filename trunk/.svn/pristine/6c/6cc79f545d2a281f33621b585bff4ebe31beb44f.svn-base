			...
			<div class="over_x">
				<div class="content-wrapper" style="min-width: 1480px;">
					...
					<div class="tan">
						...
						<div class="hysh a">
							<title>会员审核</title>
							<line> <left> <ib>ID:</ib></left> <right class='a_tan_id'></right>
							</line>
							...
							<div class="guan">
								<div style="margin-top: 50px;">审核通过后，将自动升级</div>
								<line>
						...
						<div class="hysh b">
							...
							<div style="margin-top: 50px;">注册成功后，将自动升级</div>
							<line>
...
$(function(){
  ...
  var odiv=$('<div class="h_btn_list" style=""><div class="actives" id="subbtn">审核</div><div class="" id="subbtn2">修改</div></div>');
...
$(".no-verify").click(function(){
  ...
  $('#a_unpass').click(function(){
	  ...
	  var datas={type:type,reason_remark:reason_remark,id:id};
	  $.ajax({
          url:Url,
          type:'GET',
          data:datas,

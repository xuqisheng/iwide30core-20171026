...
// 							<label for="el_act_type" class="col-sm-2 control-label">活动类型</label>
// 							<div class="col-sm-8">
// 								<select class="form-control selectpicker show-tick" data-live-search="true" name="act_type" id="el_act_type">
// 									'.$options.'
// 								</select>
// 							</div>
// 						</div>';

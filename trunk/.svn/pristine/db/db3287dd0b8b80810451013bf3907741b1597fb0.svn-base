...
<!-- Horizontal Form -->
    ...
    <div class="tabbable "> <!-- Only required for left/right tabs -->
			...
			<?php echo form_open( site_url('pay/lakalapay/edit_post'), array('class'=>'form-horizontal','enctype'=>'multipart/form-data' )); ?>
              			    <div class="box-body">
...
// 		$('#el_logo').parent().append('<input type="file" value="上传图片" id="upfiles">');
		$('#certs').uploadify({
			...
			'uploader' : '<?php echo site_url('pay/lakalapay/cert_upload_url') ?>',

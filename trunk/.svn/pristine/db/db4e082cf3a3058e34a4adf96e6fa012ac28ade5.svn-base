...
<?php if(!empty($result)){ foreach($result as $r){?>
	<a onclick="go_hotel('index?id=<?php echo $inter_id?>&h=<?php echo $r->hotel_id?>&type=<?php echo $type?>')" href="javascript:void(0);" class="item">
        <div class="ui_img_auto_cut"><img class="lazy" src="<?php echo referurl('img','default2.jpg',3,$media_path) ?>"  data-original="<?php echo $r->intro_img?>" /></div>
        <div class="allin_box">
            ...
            <div class="h20 color_link txtclip" style="max-width:15em"><?php if(!empty($r->characters)){echo $r->characters;}?></div>

   ...
   <div class="weui_panel bg_f">
    ...
    <div class="weui_panel border_bottom border_top bg_f m_t_4 h28">
        ...
        <div class="weui_cell txt-line-height" style="align-items:flex-start;">
            <div class="weui_cell_hd width">
                <label class="weui_label emwith">实际付款</label>
            </div>
            <div class="weui_cell_bd weui_cell_primary txt-float-right">
    ...
    $(document).ready(function(){
        ...
        function checkSale(){
           ...
           if(no_sale == 1){
            ...
            //最后把不打折金额补上来
            if(no_sale_money != null && no_sale_money > 0){
                money = money + no_sale_money;
            }
            //有可能用户输入后，又删除金额
                                ...
                                setTimeout(function(){
                                    ...
                                    $.post(url,
                                        {'money':parseFloat($("#money").val()),
                                            ...
                                            'no_sale_money':parseFloat($("#no_sale").val()),
        ...
        $("#s_check").bind("click",function(){
            if($(this).prop("checked")){
                $("#no_sale_display").show();
                $("#ck_add_no_sale").val(1);
                $("#no_sale").focus();
            }else{
                $("#no_sale").val(0);
                $("#no_sale_display").hide();
                $("#ck_add_no_sale").val(0);
                checkSale();
            }
        });
    });

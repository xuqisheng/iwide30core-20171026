...
//分类管理
class Category_package extends MY_Admin_Soma{
	protected $label_module= NAV_PACKAGE_GROUPON;		//统一在 constants.php 定义
	protected $label_controller= '分类列表';		//在文件定义
	protected $label_action= '';				//在方法中定义
	
	protected function main_model_name()
	{
		return 'soma/category_package_model';
	}

	public function grid()
	{
		$this->label_action= '分类列表';

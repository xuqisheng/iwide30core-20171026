...
$buttions.= '<button type="button" class="btn btn-sm disabled" id="grid-btn-edit"><i class="fa fa-edit"></i>&nbsp;查看明细</button>';
...
$buttions.= '<button type="button" class="btn btn-sm btn-success" id="export_btn"><i class="fa fa-trash"></i>&nbsp;导出</button>';
...
$('#export_btn').click(function(){
  window.location= '<?php echo Soma_const_url::inst()->get_url("*/*/export") . '?' . http_build_query($this->input->get(null, true)); ?>';
});

          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <!-- 
                ...
                <div class="row">
                	<div class="col-sm-12">
                	<?php echo form_open('membervip/membermanage/new_bind_member_fans/','class="form-inline"')?>
                  ...
                  <table id="data-grid" class="table table-bordered table-striped table-condensed">
                    <thead>
                        <th width="10%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="会员卡编号: activate to sort column ascending">会员卡编号</th>
                        <th width="10%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="粉丝openid: activate to sort column ascending">粉丝openid</th>
                        <th width="10%" class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="会员创建时间: activate to sort column ascending">会员卡创建时间</th>
                  ...
                  <div class="row">
	                  <div class="col-sm-5">
	                  	<div class="dataTables_info" id="data-grid_info" role="status" aria-live="polite">共<?=$total?>条<a class="btn btn-sm bg-green" href="<?php echo site_url("membervip/membermanage/ext_new_bind_member_fans/".$posts['begin_time'].'_'.$posts['end_time'])?>">导出</a></div>
	                  </div>
	                  <div class="col-sm-7">
...
$('#grid-btn-set').click(function(){
    ...
    // 	  modal.find('.modal-body input').val(recipient)
        ...
        $.getJSON('<?php echo site_url("distribute/distri_report/get_cofigs?ctyp=mem_new_bind")?>',function(data){
            if(data != null){

...
<header class="pad3">
    ...
    <div class="h24">出行时间：<?php echo date("m月d日",strtotime($startdate));?></div>
    <div class="h24 color_888 martop"><?php foreach($room_list as $rl)echo $rl['name'].' ';?>(<?php echo $first_state['price_name'];?>)</div>
...
<!-- 以上为 续住 部分 -->
<div class="list_style bd martop" style="display: none;">
...
<div class="martop pad3 webkitbox input_item bg_fff bd" style="-webkit-box-align:baseline; padding-right:0">
    ...
    <?php if($pw->pay_type=='point') continue;?>
...
<div style="padding-top:15%">
    <div class="foot_fixed">
		...
		<?php if($total_oprice>$total_price){?>
        	...
        	<span class="price_detail h20 color_888 martop" style=" float:right;display: none;">明细 <em class="iconfont" style="font-size:5px">&#x49;</em></span>
        </div>

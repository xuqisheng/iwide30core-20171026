            ...
            <?php foreach ($fields_config as $k=>$v): ?>
				...
				<?php if($k == 'password'): ?>
					<div class="form-group  has-feedback">
						<label for="el_password" class="col-sm-2 control-label">登录密码</label>
						<div class="col-sm-8"><input type="password" class="form-control " name="password" id="el_password" placeholder="密码" value=""></div>
					</div>
					<div class="form-group  has-feedback">
						<label for="el_password" class="col-sm-2 control-label">确认密码</label>
						<div class="col-sm-8"><input type="password" class="form-control " name="password_comfirm" id="el_password_comfirm" placeholder="密码" value=""></div>
					</div>
				<?php else: ?>
					<?php 

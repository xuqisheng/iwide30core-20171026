...
var url_add= '<?php echo EA_const_url::inst()->get_url("*/*/plus"); ?>';			//跟button对应
var url_edit= '<?php echo EA_const_url::inst()->get_url("*/*/plus"); ?>';		//跟button对应
var url_delete= '<?php echo EA_const_url::inst()->get_url("*/*/remove"); ?>';	//跟button对应

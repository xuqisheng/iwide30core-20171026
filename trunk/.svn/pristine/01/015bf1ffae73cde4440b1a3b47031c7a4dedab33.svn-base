                  ...
                  <table id="data-grid" class="table table-bordered table-striped table-condensed">
                    <thead>
                        ...
                        <th class="sorting_desc" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-sort="descending" aria-label="订单号: activate to sort column ascending">系统订单号</th>
                    		...
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="订单状态: activate to sort column ascending">订单状态</th>
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="姓名: activate to sort column ascending">姓名</th>
                    		...
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="支付方式: activate to sort column ascending">支付方式</th>
<!--                     		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="支付状态: activate to sort column ascending">支付状态</th> -->
                    		...
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="粉丝所属员工: activate to sort column ascending">粉丝所属员工</th>
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="订单佣金: activate to sort column ascending">订单佣金</th>
                    		<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="渠道: activate to sort column ascending">渠道</th></tr></thead>
                    ...
                    <tbody><?php foreach ($res as $item):?>
                        ...
                        <td><?=$item['orderid']?></td>
                    		...
                    		<td><?=$status[$item['istatus']]?></td>
                    		<td><?=$item['name']?></td>
                    		<td><?=isset($hotels[$item['ohotel_id']]) ? $hotels[$item['ohotel_id']] : '-'?></td>
                    		...
                    		<td><?=$item['price']?></td>
                    		<td><?=isset($paytype[$item['paytype']]) ? $paytype[$item['paytype']] : '到付'?></td>
                    		<!--<td><?=$paid[$item['paid']]?></td>-->
                    		...
                    		<td><?=isset($source[$item['is_distributed']]) ? $source[$item['is_distributed']] : '公共'?></td>
                    	</tr><?php endforeach;?>
                    </tbody>
                  </table>
                  <div class="row">

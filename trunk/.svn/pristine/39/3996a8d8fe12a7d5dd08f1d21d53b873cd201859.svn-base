        ...
        <div><br/>
            <div class="weui_cell">
                <div class="weui_cell_bd ">
                    <a href="<?php echo site_url("membervip/reg").'?redir='.$redir;?>" style="margin-left:3px;">立即注册</a>
                </div>
                <?php if($inter_id!='a421641095'&&$inter_id!='a480304439'&&$inter_id!='a482718699'):?>
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if(result.err=='0'){
                            	...
                            	if(result.err == '2023'){
									new AlertBox({content:result.msg,type:'confirm',site:'topmid',okVal:'注册',cancelVal:'关闭',dourl:"<?php echo base_url('index.php/membervip/reg').'?redir='.$redir;?>",
		                        		ok:function () {	var locat_url = '<?php echo site_url('membervip/reg').'?redir='.$redir;?>'; location.href = locat_url;}
		                             }
		                              ).show();
		                              return false;
									}

...
<script src="<?php echo base_url('public/distribute/default/scripts/fill_in.js')?>"></script>
...
<body>
<div class="f_box"><?php foreach ($saler_details as $fans):?>
	<a href="<?php echo site_url('distribute/distribute/fans_blogs')?>?id=<?php echo $inter_id?>&fid=<?php echo $fans->fid?>"><div class="fans clearfix">

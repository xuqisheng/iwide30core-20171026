...
<?php if(isset($id)){?>
<?php echo form_open('take-away/shop/edit?ids='.$id,array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }else{?>
<?php echo form_open('take-away/shop/add',array('id'=>'tosave','class'=>'form-horizontal','enctype'=>'multipart/form-data','onsubmit'=>'return sub();' ))?>
<?php }?>
    ...
    <div class="bd_left list_layout">
        ...
        <div>
            ...
            <div class="flex flexcenter" style="max-width: 800px;!important">
                ...
                <label class="check"><input name="sale_type" type="radio" value="<?php echo $sk?>" <?php if(!empty($posts['sale_type'])&&$posts['sale_type']==$sk ||(!isset($id) && $sk==3)){echo "checked='checked'";}?> onclick="radiochange($(this).val())" /><span class="diyradio"><tt></tt></span><?php echo $sv?></label>
                <?php }?>
                <div class="input" id="sale_around">
                    <input name="sale_around" placeholder="请输入配送范围" value="<?php echo !empty($posts['sale_around'])?$posts['sale_around']:''?>"><span>KM</span>
                </div>
                <div class="input" id="sale_dispatching">
        ...
        <div id="shipping_type">
            ...
            <div class="flex flexcenter">
                ...
                <label class="check"><input name="shipping_type" type="radio" value="3" <?php echo isset($posts['shipping_type'])&&$posts['shipping_type']==3?' checked ':''?> /><span class="diyradio"><tt></tt></span>蜂鸟配送</label>
            </div>
        </div>
...
$('#el_hotel div').click(function(){
	$('#drowdown').empty();
	$.post('/index.php/take-away/shop/get_saler_info',{

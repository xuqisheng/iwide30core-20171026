...
class Crecord extends MY_Front_Wxapp
{
	...
	public function bonus()
	{
		...
		$this->out_put_msg ( 1, '', $data ,'member/bonus/bonus');
...
//        $data = $this->imember->couponCardList($openid,$this->inter_id);
        ...
        $this->out_put_msg ( 1, '', $data ,'member/cards/cardlist');
	...
	public function carddetail()
	{
		...
		$this->out_put_msg ( 1, '', $data ,'member/carddt');
	...
	public function balances()
	{
        ...
        $this->out_put_msg ( 1, '', $data ,'member/balances');

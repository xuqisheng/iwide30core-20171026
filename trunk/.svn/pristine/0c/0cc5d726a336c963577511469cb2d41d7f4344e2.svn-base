...
<body ontouchstart>
    <div class="vip_content" style="display:none;">
        <div class="weui_msg">
           <div class="weui_icon_area"><i class="weui_icon_success weui_icon_warn"></i></div>
           <div class="weui_text_area">
               <h2 class="weui_msg_title">支付失败</h2>
               <p class="weui_msg_desc"><?=!empty($pay_msg)?$pay_msg:'充值失败,请重新发起支付'?></p>
           </div>
           ...
           <div class="weui_extra_area">
               <a href="<?php echo $restarturl;?>">重新充值</a>
           </div>
        </div>
    </div>
    <!--BEGIN START-->

...
$buttions.= '<button type="button" class="btn btn-sm disabled"  style="margin-left:5px" id="grid-btn-edit3"><i class="fa fa-edit"></i>&nbsp;员工</button>';
...
var url_edit2= '<?php echo '../prices/gcp'; ?>';
var url_edit3= '<?php echo '../staff/s_list'; ?>';		//跟button对应
...
//        alert('123');
        var base_url= '<?php echo EA_const_url::inst()->get_url("*/prices/qrcode_front"); ?>?ids=';

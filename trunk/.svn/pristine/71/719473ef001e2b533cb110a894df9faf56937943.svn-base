...
<?php if($package['can_mail'] == $packageModel::CAN_T || $package['can_gift'] == $packageModel::CAN_T){ ?>
<!--<form action="" method="post">-->
<div class="mail_list">
    <div class="justify webkitbox bd_bottom mail_type">
		...
		<?php if($package['can_gift'] == $packageModel::CAN_T){ ?>
			<label class="jfk-input__radio"><input type="radio" class="jfk-input__radio-mail mail_type_gift" name="mail" value="2"/><em class="uncheck"></em><em class="checked iconfont color_main">&#xe61e;</em><span>赠送他人</span><span class="mail_gift_tip"><em>!</em>如何赠送</span></label>
        <?php } ?>
		</div>
    </div>
    <div class="gift_process">
...
var _submit = function(){
        ...
        // 邮寄地址
        if (userAddressArr !== null && $('[name="mail"]').filter(':checked').val() === '1' && $('[name="addressID"]').val() == 0) {
            $.MsgBox.Confirm('请选择收货地址');return false;
        }
...
var loadCityUrl = '/index.php/soma/express/tree?id=a450089706&openid=o9Vbtw4pZhVD6A1w1Cdr9xP'
var loadUserAddrUrl = '/index.php/soma/express/my?id=a450089706&openid=o9Vbtw4pZhVD6A1w1Cdr9xP'
var updateUserAddrUrl = '/index.php/soma/express/save?id=a450089706&openid=o9Vbtw4pZhVD6A1w1Cdr9xPX_Y6U'
var deleteUserAddrUrl = 'index.php/soma/express/destroy?id=a450089706&openid=o9Vbtw4pZhVD6A1w1Cdr9xPX_Y6U'
...
$addrListCont.on('click', '.modify', function (e) {
    ...
    $dialogAreaPlaceholder.text(addressObj.province_name + ' ' + addressObj.city_name + (addressObj.region ? ' ' + addressObj.region_name : ''))

...
<div class="reward_header an_rows">  
    ...
    <p class="h24"><?php echo isset($saler_info['hotel_name'])?$saler_info['hotel_name']:''?>&nbsp;&nbsp;<?php echo isset($saler_info['master_dept'])?$saler_info['master_dept']:''?></p>
    ...
    <div class="reward_rows">
        ...
        <div class="reward_content">
            <ul class="reward_content_money">
                ...
                <li class="reward_content_rows" data-money="2"><span class="h32 reward_money">2</span><span class="h20">元<span></li>
                <li class="reward_content_rows" data-money="3"><span class="h32 reward_money">3</span><span class="h20">元<span></li>
                <li class="reward_content_rows" data-money="4"><span class="h32 reward_money">4</span><span class="h20">元<span></li>
                <li class="reward_content_rows" data-money="5"><span class="h32 reward_money">5</span><span class="h20">元<span></li>
                <li class="reward_content_rows" data-money="6"><span class="h32 reward_money">6</span><span class="h20">元<span></li>
            </ul>
        ...
        $('#to_tips').click(function(){
            ...
            if(money == "" ||  money < 1){
               $(".reward_money_tips").show();
                ...
                $.post('<?php echo site_url('subatips/tips/save_order');?>',{

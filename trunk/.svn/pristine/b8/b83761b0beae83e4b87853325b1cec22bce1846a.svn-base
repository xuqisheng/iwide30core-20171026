...
<script>
$(function () {
	CKEDITOR.replace('el_order_notice',{
	  //filebrowserBrowseUrl:'../ckfinder/ckfinder.html',
      //filebrowserImageBrowseUrl:'<?php echo Soma_const_url::inst()->get_front_url($model->m_get('inter_id'), 'basic/upload/browse', $params, 'file' ); ?>',
      //filebrowserFlashBrowseUrl:
      
	  //filebrowserUploadUrl:'../ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
      filebrowserImageUploadUrl:'<?php echo Soma_const_url::inst()->get_url('basic/upload/do_upload', $params); ?>'
